...
COMMON_UI_TR = {
 "Hindi":{"Navigate":"नेविगेट करें","Language":"भाषा","Location":"स्थान","Profit Margin":"लाभ मार्जिन","Break-Even Analysis":"ब्रेक-ईवन विश्लेषण","Loan Affordability Calculator":"ऋण वहनीयता कैलकुलेटर","Monthly Cash Flow Planner":"मासिक नकदी प्रवाह योजनाकार","Principal Amount / Loan Amount (₹)":"मूलधन / ऋण राशि (₹)","Monthly Income (₹)":"मासिक आय (₹)","Existing Monthly Living Expenses (₹)":"मौजूदा मासिक घरेलू खर्च (₹)","Existing Monthly Loan EMIs (₹)":"मौजूदा मासिक ऋण EMI (₹)","Proposed Loan Interest Rate (% p.a.)":"प्रस्तावित ऋण ब्याज दर (% वार्षिक)","Proposed Loan Period (Years)":"प्रस्तावित ऋण अवधि (वर्ष)","Principal Amount":"मूलधन राशि","Estimated EMI":"अनुमानित EMI","Available Monthly Income":"उपलब्ध मासिक आय","Total Interest":"कुल ब्याज","Expected Monthly Business/Family Income (₹)":"अनुमानित मासिक व्यवसाय/पारिवारिक आय (₹)","Monthly Operating / Business Expenses (₹)":"मासिक संचालन / व्यवसाय खर्च (₹)","Monthly Household / Personal Expenses (₹)":"मासिक घरेलू / व्यक्तिगत खर्च (₹)","Total Monthly Debt / EMI Payments (₹)":"कुल मासिक ऋण / EMI भुगतान (₹)","Total Monthly Income":"कुल मासिक आय","Total Monthly Expenses":"कुल मासिक खर्च","Remaining Cash Flow":"शेष नकदी प्रवाह"},
 "Kannada":{"Navigate":"ನ್ಯಾವಿಗೇಟ್ ಮಾಡಿ","Language":"ಭಾಷೆ","Location":"ಸ್ಥಳ","Profit Margin":"ಲಾಭದ ಅಂಚು","Break-Even Analysis":"ಬ್ರೇಕ್-ಈವನ್ ವಿಶ್ಲೇಷಣೆ","Loan Affordability Calculator":"ಸಾಲದ ಕೈಗೆಟುಕುವಿಕೆ ಕ್ಯಾಲ್ಕುಲೇಟರ್","Monthly Cash Flow Planner":"ಮಾಸಿಕ ನಗದು ಹರಿವು ಯೋಜಕ","Principal Amount / Loan Amount (₹)":"ಮೂಲಧನ / ಸಾಲದ ಮೊತ್ತ (₹)","Monthly Income (₹)":"ಮಾಸಿಕ ಆದಾಯ (₹)","Existing Monthly Living Expenses (₹)":"ಪ್ರಸ್ತುತ ಮಾಸಿಕ ಜೀವನ ವೆಚ್ಚ (₹)","Existing Monthly Loan EMIs (₹)":"ಪ್ರಸ್ತುತ ಮಾಸಿಕ ಸಾಲದ EMIಗಳು (₹)","Proposed Loan Interest Rate (% p.a.)":"ಪ್ರಸ್ತಾವಿತ ಸಾಲದ ಬಡ್ಡಿದರ (% ವಾರ್ಷಿಕ)","Proposed Loan Period (Years)":"ಪ್ರಸ್ತಾವಿತ ಸಾಲದ ಅವಧಿ (ವರ್ಷಗಳು)","Principal Amount":"ಮೂಲಧನ ಮೊತ್ತ","Estimated EMI":"ಅಂದಾಜು EMI","Available Monthly Income":"ಲಭ್ಯವಿರುವ ಮಾಸಿಕ ಆದಾಯ","Total Interest":"ಒಟ್ಟು ಬಡ್ಡಿ","Expected Monthly Business/Family Income (₹)":"ನಿರೀಕ್ಷಿತ ಮಾಸಿಕ ವ್ಯವಹಾರ/ಕುಟುಂಬ ಆದಾಯ (₹)","Monthly Operating / Business Expenses (₹)":"ಮಾಸಿಕ ಕಾರ್ಯಾಚರಣೆ / ವ್ಯವಹಾರ ವೆಚ್ಚ (₹)","Monthly Household / Personal Expenses (₹)":"ಮಾಸಿಕ ಮನೆ / ವೈಯಕ್ತಿಕ ವೆಚ್ಚ (₹)","Total Monthly Debt / EMI Payments (₹)":"ಒಟ್ಟು ಮಾಸಿಕ ಸಾಲ / EMI ಪಾವತಿಗಳು (₹)","Total Monthly Income":"ಒಟ್ಟು ಮಾಸಿಕ ಆದಾಯ","Total Monthly Expenses":"ಒಟ್ಟು ಮಾಸಿಕ ವೆಚ್ಚ","Remaining Cash Flow":"ಉಳಿದ ನಗದು ಹರಿವು"}
}
for _lang,_map in COMMON_UI_TR.items(): TEXT[_lang].update(_map)
...
def translated_page_label(page_key):
    icons={"Home":"🏠","Market Prices":"📈","Government Schemes":"🏛️","Financial Assistant":"💰","Business Recommendation":"💡"}
    labels={"English":{"Home":"Home","Market Prices":"Market Prices","Government Schemes":"Schemes","Financial Assistant":"Finance","Business Recommendation":"Business"},
            "Hindi":{"Home":"होम","Market Prices":"बाज़ार भाव","Government Schemes":"योजनाएँ","Financial Assistant":"वित्त","Business Recommendation":"व्यवसाय"},
            "Kannada":{"Home":"ಮುಖಪುಟ","Market Prices":"ಮಾರುಕಟ್ಟೆ ಬೆಲೆಗಳು","Government Schemes":"ಯೋಜನೆಗಳು","Financial Assistant":"ಹಣಕಾಸು","Business Recommendation":"ವ್ಯವಹಾರ"}}
    return f"{icons[page_key]} {labels.get(_current_language(),labels['English']).get(page_key,page_key)}"
page_labels={k:translated_page_label(k) for k in page_values}
...
def _sync_top_language():
    st.session_state.language = st.session_state.get("gs_top_language", "English")
...
def render_gram_vaani_voice_assistant(page_name, location):
    '''Render a browser-native multilingual voice assistant using Web Speech API.'''
    ...
    context = {
        ...
        "temperatureSource": str(temp_source),
        "water": str(water),
    ...
    voice_lang={"English":"en-IN","Hindi":"hi-IN","Kannada":"kn-IN"}.get(_current_language(),"en-IN")
    voice_ui={
      "English":{"kicker":"Gram Sahayak Intelligence","title":"Gram Vaani · AI Voice Assistant","mic":"🎤 Tap & Speak","stop":"⏹ Listening…","read":"🔊 Read Answer","ask":"Ask","placeholder":"Ask about crops, temperature, schemes, loans, markets or business…","quick_how":"How it works","quick_temp":"🌡️ Temperature","quick_business":"💡 Business","quick_scheme":"🏛️ Schemes","quick_market":"📈 Markets","quick_npk":"🌱 NPK","hello":"Namaste! / Hello!","intro":"I am Gram Vaani. Ask me about farming, markets, schemes, finance, crops, business planning, or your selected location.","status":"Voice recognition uses your browser's speech service when supported. Microphone permission is required for Tap & Speak.","no_speech":"Speech synthesis is not supported in this browser.","no_recognition":"Voice recognition is not available in this browser. Text and read-aloud still work.","no_voice":"No matching voice was found for the selected language. Your browser will try its language fallback."},
      "Hindi":{"kicker":"ग्राम सहायक इंटेलिजेंस","title":"ग्राम वाणी · AI वॉइस असिस्टेंट","mic":"🎤 बोलने के लिए दबाएँ","stop":"⏹ सुन रहा है…","read":"🔊 उत्तर पढ़ें","ask":"पूछें","placeholder":"फसल, तापमान, योजनाओं, ऋण, बाज़ार या व्यवसाय के बारे में पूछें…","quick_how":"कैसे काम करता है","quick_temp":"🌡️ तापमान","quick_business":"💡 व्यवसाय","quick_scheme":"🏛️ योजनाएँ","quick_market":"📈 बाज़ार","quick_npk":"🌱 NPK","hello":"नमस्ते!","intro":"मैं ग्राम वाणी हूँ। खेती, बाज़ार, योजनाओं, वित्त, फसलों, व्यवसाय योजना या आपके चुने हुए स्थान के बारे में पूछें।","status":"जहाँ उपलब्ध हो, आवाज़ पहचान आपके ब्राउज़र की speech service का उपयोग करती है। बोलने के लिए माइक्रोफ़ोन अनुमति आवश्यक है।","no_speech":"इस ब्राउज़र में speech synthesis उपलब्ध नहीं है।","no_recognition":"इस ब्राउज़र में voice recognition उपलब्ध नहीं है। टेक्स्ट और read-aloud अभी भी काम करेंगे।","no_voice":"चयनित भाषा की matching voice नहीं मिली। ब्राउज़र भाषा के fallback का प्रयास करेगा।"},
      "Kannada":{"kicker":"ಗ್ರಾಮ ಸಹಾಯಕ ಇಂಟೆಲಿಜೆನ್ಸ್","title":"ಗ್ರಾಮ ವಾಣಿ · AI ಧ್ವನಿ ಸಹಾಯಕ","mic":"🎤 ಮಾತನಾಡಲು ಒತ್ತಿರಿ","stop":"⏹ ಕೇಳಲಾಗುತ್ತಿದೆ…","read":"🔊 ಉತ್ತರವನ್ನು ಓದಿ","ask":"ಕೇಳಿ","placeholder":"ಬೆಳೆ, ತಾಪಮಾನ, ಯೋಜನೆಗಳು, ಸಾಲ, ಮಾರುಕಟ್ಟೆ ಅಥವಾ ವ್ಯವಹಾರದ ಬಗ್ಗೆ ಕೇಳಿ…","quick_how":"ಹೇಗೆ ಕೆಲಸ ಮಾಡುತ್ತದೆ","quick_temp":"🌡️ ತಾಪಮಾನ","quick_business":"💡 ವ್ಯವಹಾರ","quick_scheme":"🏛️ ಯೋಜನೆಗಳು","quick_market":"📈 ಮಾರುಕಟ್ಟೆ","quick_npk":"🌱 NPK","hello":"ನಮಸ್ಕಾರ!","intro":"ನಾನು ಗ್ರಾಮ ವಾಣಿ. ಕೃಷಿ, ಮಾರುಕಟ್ಟೆ, ಯೋಜನೆಗಳು, ಹಣಕಾಸು, ಬೆಳೆಗಳು, ವ್ಯವಹಾರ ಯೋಜನೆ ಅಥವಾ ನೀವು ಆಯ್ಕೆ ಮಾಡಿದ ಸ್ಥಳದ ಬಗ್ಗೆ ಕೇಳಿ.","status":"ಲಭ್ಯವಿದ್ದಲ್ಲಿ ಧ್ವನಿ ಗುರುತಿಸುವಿಕೆ ನಿಮ್ಮ ಬ್ರೌಸರ್‌ನ speech service ಅನ್ನು ಬಳಸುತ್ತದೆ. ಮಾತನಾಡಲು ಮೈಕ್ರೊಫೋನ್ ಅನುಮತಿ ಅಗತ್ಯವಿದೆ.","no_speech":"ಈ ಬ್ರೌಸರ್‌ನಲ್ಲಿ speech synthesis ಲಭ್ಯವಿಲ್ಲ.","no_recognition":"ಈ ಬ್ರೌಸರ್‌ನಲ್ಲಿ voice recognition ಲಭ್ಯವಿಲ್ಲ. ಪಠ್ಯ ಮತ್ತು ಉತ್ತರ ಓದುವಿಕೆ ಇನ್ನೂ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತದೆ.","no_voice":"ಆಯ್ಕೆ ಮಾಡಿದ ಭಾಷೆಗೆ ಹೊಂದುವ ಧ್ವನಿ ಸಿಗಲಿಲ್ಲ. ಬ್ರೌಸರ್ ಭಾಷೆಯ fallback ಅನ್ನು ಪ್ರಯತ್ನಿಸುತ್ತದೆ."}
    }[_current_language()]
    html_code = f'''
<!doctype html>
<html><head><meta charset="utf-8">
<style>
*{{box-sizing:border-box}}body{{margin:0;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;background:linear-gradient(135deg,#0d3b18,#1f6b2a 55%,#e8f5e9);color:#fff}}
...
h1{{font-size:22px;margin:2px 0 0;font-weight:850}}
...
.controls{{display:grid;grid-template-columns:1.1fr 1.1fr 1fr;gap:9px;margin-top:15px;position:relative;z-index:1}}
button,select{{border:1px solid rgba(255,255,255,.22);border-radius:11px;padding:10px 11px;background:rgba(255,255,255,.12);color:#fff;font-weight:750;font-size:12px;cursor:pointer;outline:none}}
...
input{{flex:1;border:1px solid rgba(255,255,255,.22);border-radius:11px;padding:11px 12px;background:rgba(255,255,255,.12);color:#fff;font-size:13px;outline:none}}
input::placeholder{{color:rgba(255,255,255,.68)}}
.answer{{margin-top:11px;background:#fff;color:#243127;border-radius:14px;padding:13px 14px;min-height:68px;box-shadow:0 8px 20px rgba(0,0,0,.12);line-height:1.5;font-size:13px;position:relative;z-index:1}}
.answer b{{color:#1b5e20}}
.quick{{display:flex;gap:7px;flex-wrap:wrap;margin-top:9px;position:relative;z-index:1}}
.quick button{{font-size:10px;padding:7px 9px;background:rgba(255,255,255,.1)}}
.status{{font-size:10px;opacity:.72;margin-top:8px;position:relative;z-index:1}}
@media(max-width:650px){{.controls{{grid-template-columns:1fr}}.badge{{display:none}}}}
</style></head>
<body><div class="wrap"><div class="glow"></div>
<div class="top"><div class="brand"><div class="logo">🎙️</div><div><div class="kicker">{voice_ui["kicker"]}</div><h1>{voice_ui["title"]}</h1></div></div><div class="badge">EN • HI • KN</div></div>
<div class="controls">
<select id="lang"><option value="en-IN"{" selected" if voice_lang=="en-IN" else ""}>English · India</option><option value="hi-IN"{" selected" if voice_lang=="hi-IN" else ""}>हिन्दी</option><option value="kn-IN"{" selected" if voice_lang=="kn-IN" else ""}>ಕನ್ನಡ</option></select>
<button class="mic" id="mic">{voice_ui["mic"]}</button>
<button id="speak">{voice_ui["read"]}</button>
</div>
<div class="ask"><input id="q" placeholder="{voice_ui["placeholder"]}"><button id="ask">{voice_ui["ask"]}</button></div>
<div class="quick"><button data-q="How does Gram Sahayak work?">{voice_ui["quick_how"]}</button><button data-q="What is the temperature at my location?">{voice_ui["quick_temp"]}</button><button data-q="Tell me about business recommendation">{voice_ui["quick_business"]}</button><button data-q="Tell me about government schemes">{voice_ui["quick_scheme"]}</button><button data-q="Tell me about market prices">{voice_ui["quick_market"]}</button><button data-q="Explain NPK">{voice_ui["quick_npk"]}</button></div>
<div class="answer" id="answer"><b>{voice_ui["hello"]}</b><br>{voice_ui["intro"]}</div>
<div class="status" id="status">{voice_ui["status"]}</div>
</div>
<script>
const C={{context:{context_json},lang:'{voice_lang}'}};
const A={{
...
function current(){{return A[C.lang]||A['en-IN']}}
function answerFor(q){{const x=(q||'').toLowerCase();const a=current();
if(!x.trim()) return a.hello;
if(x.includes('temperature')||x.includes('तापमान')||x.includes('ತಾಪಮಾನ')||x.includes('weather')||x.includes('मौसम')||x.includes('ಹವಾಮಾನ')) return a.temp();
if(x.includes('location')||x.includes('स्थान')||x.includes('स्थल')||x.includes('ಸ್ಥಳ')) return a.loc();
if(x.includes('business')||x.includes('व्यवसाय')||x.includes('ವ್ಯವಹಾರ')||x.includes('recommend')) return a.business;
if(x.includes('scheme')||x.includes('योजना')||x.includes('योजन')||x.includes('ಯೋಜನೆ')||x.includes('subsid')) return a.scheme;
if(x.includes('market')||x.includes('mandi')||x.includes('मंडी')||x.includes('बाजार')||x.includes('ಮಾರುಕಟ್ಟೆ')) return a.market;
if(x.includes('loan')||x.includes('emi')||x.includes('finance')||x.includes('ऋण')||x.includes('कर्ज')||x.includes('ಹಣಕಾಸು')||x.includes('ಸಾಲ')) return a.finance;
if(x.includes('npk')||x.includes('nitrogen')||x.includes('नाइट्रोजन')||x.includes('ನೈಟ್ರೋಜನ್')) return a.npk;
if(x.includes('how')||x.includes('work')||x.includes('कैसे')||x.includes('काम')||x.includes('ಹೇಗೆ')||x.includes('ಕೆಲಸ')) return a.how;
return C.context.page==='Business Recommendation'?a.business:(a.hello+' '+a.how);}}
...
function pickVoice(langCode){{
 const exact=VOICES.filter(v=>String(v.lang||'').toLowerCase()===langCode.toLowerCase());
 if(exact.length)return exact[0];
 const base=langCode.split('-')[0].toLowerCase();
 const same=VOICES.filter(v=>String(v.lang||'').toLowerCase().startsWith(base+'-'));
 if(same.length)return same[0];
 const named=VOICES.filter(v=>String(v.name||'').toLowerCase().includes(base==='kn'?'kannada':base==='hi'?'hindi':'english'));
 return named[0]||null;
}}
function speakText(t){{
 if(!('speechSynthesis' in window)){{status.textContent='{voice_ui["no_speech"]}';return;}}
 const text=String(t||'').replace(/[*_#`]/g,'').replace(/\s+/g,' ').trim();
 if(!text)return;
 window.speechSynthesis.cancel();
 const voice=pickVoice(C.lang);
 if(!voice && C.lang==='kn-IN')status.textContent='{voice_ui["no_voice"]}';
 const parts=text.match(/[^.!?।॥]+[.!?।॥]?/gu)||[text];
 parts.forEach((part,i)=>{{
  const u=new SpeechSynthesisUtterance(part.trim());
  u.lang=C.lang;u.rate=.92;u.pitch=1.0;
  if(voice)u.voice=voice;
  if(i===parts.length-1)u.onend=()=>{{status.textContent='';}};
  window.speechSynthesis.speak(u);
 }});
}}
function askNow(){{const t=answerFor(q.value);show(t);speakText(t)}}
document.getElementById('ask').onclick=askNow;
speak.onclick=()=>speakText(ans.innerText);
lang.onchange=()=>{{C.lang=lang.value;loadVoices();show(current().hello);status.textContent='Language set to '+lang.options[lang.selectedIndex].text;speakText(current().hello);}};
q.addEventListener('keydown',e=>{{if(e.key==='Enter')askNow()}});
document.querySelectorAll('.quick button').forEach(b=>b.onclick=()=>{{q.value=b.dataset.q;askNow()}});
const SR=window.SpeechRecognition||window.webkitSpeechRecognition;
if(!SR){{mic.disabled=true;mic.textContent='{voice_ui["mic"]}';status.textContent='{voice_ui["no_recognition"]}'}}else{{const r=new SR();r.continuous=false;r.interimResults=false;r.maxAlternatives=1;r.onstart=()=>{{mic.classList.add('listening');mic.textContent='{voice_ui["stop"]}';status.textContent='Listening in '+lang.options[lang.selectedIndex].text+'…'}};r.onend=()=>{{mic.classList.remove('listening');mic.textContent='{voice_ui["mic"]}'}};r.onerror=e=>{{mic.classList.remove('listening');mic.textContent='{voice_ui["mic"]}';status.textContent='Microphone error: '+e.error}};r.onresult=e=>{{const text=e.results[0][0].transcript;q.value=text;askNow()}};mic.onclick=()=>{{if(mic.classList.contains('listening')) r.stop(); else {{r.lang=C.lang;r.start()}}}}}}
</script></body></html>
'''
    components.html(html_code, height=385, scrolling=False)
