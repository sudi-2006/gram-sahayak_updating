...
if page == "Home":
    ...
    <div id="gs-how" class="gs-how gs-section">
      ...
      <p class="gs-note">One location, connected agricultural tools, and step-by-step guidance based on the information you provide.</p>
      <div class="gs-process">
        <div class="gs-step"><div class="gs-number">1</div><div class="gs-step-title">📍 Set Your Location</div><div class="gs-step-text">Choose your location once. The same location is reused across relevant features, including market and business assessments.</div></div>
        <div class="gs-arrow">→</div>
        <div class="gs-step"><div class="gs-number">2</div><div class="gs-step-title">🌾 Choose a Tool</div><div class="gs-step-text">Use Crop Information, Market Prices, Government Schemes, Financial Assistant, or Business Recommendation.</div></div>
        <div class="gs-arrow">→</div>
        <div class="gs-step"><div class="gs-number">3</div><div class="gs-step-title">📝 Enter Relevant Details</div><div class="gs-step-text">Provide the inputs needed for the selected tool. Business Recommendation guides you through business selection, inputs, and generated options.</div></div>
        <div class="gs-arrow">→</div>
        <div class="gs-step"><div class="gs-number">4</div><div class="gs-step-title">📊 Get Actionable Results</div><div class="gs-step-text">View crop or market information, scheme details, financial guidance, or a business-specific strategic output with next steps.</div></div>
      </div>
    </div>
    """, unsafe_allow_html=True)
...
def apply_location_context_to_business_values(domain_name, values, location):
    ...
    if domain_name=="Agriculture":
        if out.get("temperature") in (None,"",0) and ctx.get("temperature_c") is not None: out["temperature"]=ctx["temperature_c"]
