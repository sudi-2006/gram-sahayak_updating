...
GLOBAL_UI_TR = {
    "Hindi": {
        "Navigate":"नेविगेट करें", "Location":"स्थान", "Language":"भाषा",
        "Step 1 — Select Business":"चरण 1 — व्यवसाय चुनें", "Step 2 — Enter Inputs":"चरण 2 — जानकारी भरें", "Step 3 — Strategic Output":"चरण 3 — रणनीतिक परिणाम",
        "Complete Step 1, then Step 2. Step 3 appears only after recommendations are generated and lets you select an activity for its strategic guidance and related schemes.":"पहले चरण 1 और फिर चरण 2 पूरा करें। सिफारिशें बनने के बाद ही चरण 3 दिखाई देगा, जहाँ आप रणनीतिक मार्गदर्शन और संबंधित योजनाओं के लिए गतिविधि चुन सकते हैं।",
        "Choose the business domain and activity first. The selected location is reused automatically throughout this assessment.":"पहले व्यवसाय क्षेत्र और गतिविधि चुनें। चुना गया स्थान इस पूरे आकलन में अपने आप उपयोग होगा।",
        "Numeric inputs start at 0 and text inputs start blank. Water and temperature are taken automatically from the selected location.":"संख्यात्मक इनपुट 0 से शुरू होते हैं और टेक्स्ट बॉक्स खाली रहते हैं। पानी और तापमान चयनित स्थान से अपने आप लिए जाते हैं।",
        "Select the generated activity you want. Execution, advisory, risks, financial guidance and related schemes appear below.":"अपनी पसंद की तैयार गतिविधि चुनें। इसके नीचे कार्यान्वयन, मार्गदर्शन, जोखिम, वित्तीय जानकारी और संबंधित योजनाएँ दिखाई देंगी।",
        "Select your preferred business option":"अपनी पसंद का व्यवसाय विकल्प चुनें",
        "Used automatically for this assessment":"इस आकलन में अपने आप उपयोग किया जाता है",
        "Temperature source":"तापमान स्रोत", "The temperature field is automatic and cannot be manually overridden.":"तापमान फ़ील्ड स्वचालित है और इसे मैन्युअल रूप से बदला नहीं जा सकता।",
        "Location & Climate Parameters":"स्थान और जलवायु पैरामीटर", "Soil & Water Profile":"मिट्टी और पानी प्रोफ़ाइल", "Capital & Financial Goals":"पूंजी और वित्तीय लक्ष्य",
        "Generate Business Recommendations":"व्यवसाय सिफारिशें बनाएं", "Species / Variety / Product Selection":"प्रजाति / किस्म / उत्पाद चयन",
        "Choose the crop, animal type, fish species, nursery plant, processed product or service type you plan to work with.":"वह फसल, पशु प्रकार, मछली प्रजाति, नर्सरी पौधा, प्रसंस्कृत उत्पाद या सेवा प्रकार चुनें जिसके साथ आप काम करना चाहते हैं।",
        "Business Domain":"व्यवसाय क्षेत्र", "Business Activity":"व्यवसाय गतिविधि", "Water availability":"पानी की उपलब्धता", "Irrigation baseline":"सिंचाई आधार", "Location temperature":"स्थान का तापमान", "Rainfall":"वर्षा",
        "Related Government Schemes":"संबंधित सरकारी योजनाएँ", "Home":"होम", "Market Prices":"बाज़ार भाव", "Government Schemes":"सरकारी योजनाएँ", "Financial Assistant":"वित्तीय सहायक", "Business Recommendation":"व्यवसाय सिफारिश", "Finance":"वित्त", "Business":"व्यवसाय", "Schemes":"योजनाएँ",
        "Refresh":"रिफ्रेश", "Ask":"पूछें", "Read Answer":"उत्तर सुनें", "Tap & Speak":"बोलकर पूछें",
        "Principal Amount / Loan Amount (₹)":"मूलधन / ऋण राशि (₹)", "Monthly Income (₹)":"मासिक आय (₹)", "Existing Monthly Living Expenses (₹)":"मौजूदा मासिक घरेलू खर्च (₹)", "Existing Monthly Loan EMIs (₹)":"मौजूदा मासिक ऋण EMI (₹)", "Proposed Loan Interest Rate (% p.a.)":"प्रस्तावित ऋण ब्याज दर (% वार्षिक)", "Proposed Loan Period (Years)":"प्रस्तावित ऋण अवधि (वर्ष)",
        "Expected Monthly Business/Family Income (₹)":"अपेक्षित मासिक व्यवसाय/परिवार आय (₹)", "Monthly Operating / Business Expenses (₹)":"मासिक संचालन / व्यवसाय खर्च (₹)", "Monthly Household / Personal Expenses (₹)":"मासिक घरेलू / व्यक्तिगत खर्च (₹)", "Total Monthly Debt / EMI Payments (₹)":"कुल मासिक ऋण / EMI भुगतान (₹)",
        "Financial Safety Note":"वित्तीय सुरक्षा नोट", "Financial Assistant provides planning calculations such as EMI, affordability and cash-flow views.":"वित्तीय सहायक EMI, वहनीयता और कैश-फ्लो जैसी योजना गणनाएँ देता है।",
        "No price reported today":"आज कोई मूल्य रिपोर्ट नहीं हुआ", "Source: Government of India • data.gov.in • Agmarknet daily mandi prices (Karnataka).":"स्रोत: भारत सरकार • data.gov.in • Agmarknet दैनिक मंडी भाव (कर्नाटक)।",
    },
    "Kannada": {
        "Navigate":"ನ್ಯಾವಿಗೇಟ್ ಮಾಡಿ", "Location":"ಸ್ಥಳ", "Language":"ಭಾಷೆ",
        "Step 1 — Select Business":"ಹಂತ 1 — ವ್ಯವಹಾರ ಆಯ್ಕೆ", "Step 2 — Enter Inputs":"ಹಂತ 2 — ಮಾಹಿತಿ ನಮೂದು", "Step 3 — Strategic Output":"ಹಂತ 3 — ತಂತ್ರಾತ್ಮಕ ಫಲಿತಾಂಶ",
        "Complete Step 1, then Step 2. Step 3 appears only after recommendations are generated and lets you select an activity for its strategic guidance and related schemes.":"ಮೊದಲು ಹಂತ 1 ಮತ್ತು ನಂತರ ಹಂತ 2 ಪೂರ್ಣಗೊಳಿಸಿ. ಶಿಫಾರಸುಗಳನ್ನು ರಚಿಸಿದ ನಂತರ ಮಾತ್ರ ಹಂತ 3 ಕಾಣಿಸುತ್ತದೆ; ಅಲ್ಲಿ ತಂತ್ರಾತ್ಮಕ ಮಾರ್ಗದರ್ಶನ ಮತ್ತು ಸಂಬಂಧಿತ ಯೋಜನೆಗಳಿಗಾಗಿ ಚಟುವಟಿಕೆಯನ್ನು ಆಯ್ಕೆ ಮಾಡಬಹುದು.",
        "Choose the business domain and activity first. The selected location is reused automatically throughout this assessment.":"ಮೊದಲು ವ್ಯವಹಾರ ಕ್ಷೇತ್ರ ಮತ್ತು ಚಟುವಟಿಕೆಯನ್ನು ಆಯ್ಕೆಮಾಡಿ. ಆಯ್ಕೆ ಮಾಡಿದ ಸ್ಥಳವನ್ನು ಈ ಸಂಪೂರ್ಣ ಮೌಲ್ಯಮಾಪನದಲ್ಲಿ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಬಳಸಲಾಗುತ್ತದೆ.",
        "Numeric inputs start at 0 and text inputs start blank. Water and temperature are taken automatically from the selected location.":"ಸಂಖ್ಯಾತ್ಮಕ ಇನ್‌ಪುಟ್‌ಗಳು 0ರಿಂದ ಆರಂಭವಾಗುತ್ತವೆ ಮತ್ತು ಪಠ್ಯ ಬಾಕ್ಸ್‌ಗಳು ಖಾಲಿಯಾಗಿರುತ್ತವೆ. ನೀರು ಮತ್ತು ತಾಪಮಾನವನ್ನು ಆಯ್ಕೆ ಮಾಡಿದ ಸ್ಥಳದಿಂದ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಪಡೆಯಲಾಗುತ್ತದೆ.",
        "Select the generated activity you want. Execution, advisory, risks, financial guidance and related schemes appear below.":"ನಿಮಗೆ ಬೇಕಾದ ರಚಿಸಲಾದ ಚಟುವಟಿಕೆಯನ್ನು ಆಯ್ಕೆಮಾಡಿ. ಅದರ ಕೆಳಗೆ ಕಾರ್ಯಗತಗೊಳಿಸುವಿಕೆ, ಮಾರ್ಗದರ್ಶನ, ಅಪಾಯಗಳು, ಹಣಕಾಸು ಮಾಹಿತಿ ಮತ್ತು ಸಂಬಂಧಿತ ಯೋಜನೆಗಳು ಕಾಣಿಸುತ್ತವೆ.",
        "Select your preferred business option":"ನಿಮ್ಮ ಇಷ್ಟದ ವ್ಯವಹಾರ ಆಯ್ಕೆಯನ್ನು ಆರಿಸಿ",
        "Used automatically for this assessment":"ಈ ಮೌಲ್ಯಮಾಪನದಲ್ಲಿ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಬಳಸಲಾಗುತ್ತದೆ",
        "Temperature source":"ತಾಪಮಾನ ಮೂಲ", "The temperature field is automatic and cannot be manually overridden.":"ತಾಪಮಾನ ಕ್ಷೇತ್ರವು ಸ್ವಯಂಚಾಲಿತವಾಗಿದ್ದು ಅದನ್ನು ಕೈಯಾರೆ ಬದಲಾಯಿಸಲಾಗುವುದಿಲ್ಲ.",
        "Location & Climate Parameters":"ಸ್ಥಳ ಮತ್ತು ಹವಾಮಾನ ನಿಯತಾಂಕಗಳು", "Soil & Water Profile":"ಮಣ್ಣು ಮತ್ತು ನೀರಿನ ಪ್ರೊಫೈಲ್", "Capital & Financial Goals":"ಬಂಡವಾಳ ಮತ್ತು ಹಣಕಾಸಿನ ಗುರಿಗಳು",
        "Generate Business Recommendations":"ವ್ಯವಹಾರ ಶಿಫಾರಸುಗಳನ್ನು ರಚಿಸಿ", "Species / Variety / Product Selection":"ಜಾತಿ / ತಳಿ / ಉತ್ಪನ್ನ ಆಯ್ಕೆ",
        "Choose the crop, animal type, fish species, nursery plant, processed product or service type you plan to work with.":"ನೀವು ಕೆಲಸ ಮಾಡಲು ಬಯಸುವ ಬೆಳೆ, ಪ್ರಾಣಿ ಪ್ರಕಾರ, ಮೀನು ಜಾತಿ, ನರ್ಸರಿ ಸಸ್ಯ, ಸಂಸ್ಕರಿತ ಉತ್ಪನ್ನ ಅಥವಾ ಸೇವಾ ಪ್ರಕಾರವನ್ನು ಆಯ್ಕೆಮಾಡಿ.",
        "Business Domain":"ವ್ಯವಹಾರ ಕ್ಷೇತ್ರ", "Business Activity":"ವ್ಯವಹಾರ ಚಟುವಟಿಕೆ", "Water availability":"ನೀರಿನ ಲಭ್ಯತೆ", "Irrigation baseline":"ನೀರಾವರಿ ಆಧಾರ", "Location temperature":"ಸ್ಥಳದ ತಾಪಮಾನ", "Rainfall":"ಮಳೆ",
        "Related Government Schemes":"ಸಂಬಂಧಿತ ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು", "Home":"ಮುಖಪುಟ", "Market Prices":"ಮಾರುಕಟ್ಟೆ ಬೆಲೆಗಳು", "Government Schemes":"ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು", "Financial Assistant":"ಹಣಕಾಸು ಸಹಾಯಕ", "Business Recommendation":"ವ್ಯವಹಾರ ಶಿಫಾರಸು", "Finance":"ಹಣಕಾಸು", "Business":"ವ್ಯವಹಾರ", "Schemes":"ಯೋಜನೆಗಳು",
        "Refresh":"ರಿಫ್ರೆಶ್", "Ask":"ಕೇಳಿ", "Read Answer":"ಉತ್ತರವನ್ನು ಕೇಳಿ", "Tap & Speak":"ಮಾತನಾಡಿ ಕೇಳಿ",
        "Principal Amount / Loan Amount (₹)":"ಮೂಲಧನ / ಸಾಲದ ಮೊತ್ತ (₹)", "Monthly Income (₹)":"ಮಾಸಿಕ ಆದಾಯ (₹)", "Existing Monthly Living Expenses (₹)":"ಪ್ರಸ್ತುತ ಮಾಸಿಕ ಜೀವನ ವೆಚ್ಚ (₹)", "Existing Monthly Loan EMIs (₹)":"ಪ್ರಸ್ತುತ ಮಾಸಿಕ ಸಾಲದ EMI (₹)", "Proposed Loan Interest Rate (% p.a.)":"ಪ್ರಸ್ತಾವಿತ ಸಾಲದ ಬಡ್ಡಿದರ (% ವಾರ್ಷಿಕ)", "Proposed Loan Period (Years)":"ಪ್ರಸ್ತಾವಿತ ಸಾಲದ ಅವಧಿ (ವರ್ಷ)",
        "Expected Monthly Business/Family Income (₹)":"ನಿರೀಕ್ಷಿತ ಮಾಸಿಕ ವ್ಯವಹಾರ/ಕುಟುಂಬ ಆದಾಯ (₹)", "Monthly Operating / Business Expenses (₹)":"ಮಾಸಿಕ ಕಾರ್ಯಾಚರಣೆ / ವ್ಯವಹಾರ ವೆಚ್ಚ (₹)", "Monthly Household / Personal Expenses (₹)":"ಮಾಸಿಕ ಮನೆ / ವೈಯಕ್ತಿಕ ವೆಚ್ಚ (₹)", "Total Monthly Debt / EMI Payments (₹)":"ಒಟ್ಟು ಮಾಸಿಕ ಸಾಲ / EMI ಪಾವತಿಗಳು (₹)",
        "No price reported today":"ಇಂದು ಯಾವುದೇ ಬೆಲೆ ವರದಿಯಾಗಿಲ್ಲ", "Source: Government of India • data.gov.in • Agmarknet daily mandi prices (Karnataka).":"ಮೂಲ: ಭಾರತ ಸರ್ಕಾರ • data.gov.in • Agmarknet ದೈನಂದಿನ ಮಂಡಿ ಬೆಲೆಗಳು (ಕರ್ನಾಟಕ).",
    }
}
...
def tr_any(value, **kwargs):
    ...
    if translated is None:
        translated = GLOBAL_UI_TR.get(language, {}).get(text, None)
    if translated is None:
...
page_labels = {
    "Home": "🏠 Home", "Market Prices": "📈 Market Prices", "Government Schemes": "🏛️ Schemes",
    "Financial Assistant": "💰 Finance", "Business Recommendation": "💡 Business"
}
...
with nav_pages:
    page = st.radio(
        ...
        format_func=lambda x: f"{page_labels[x].split(maxsplit=1)[0]} {tr_any(page_labels[x].split(maxsplit=1)[1])}",
        horizontal=True,
        key="gs_top_page"
    )
with nav_lang:
...
def render_gram_vaani_voice_assistant(page_name, location):
    ...
    context = {
        "page": str(page_name), "location": str(location), "temperature": round(float(temp), 1),
        "temperatureSource": str(temp_source), "water": str(water), "rainfall": str(rainfall),
...
*{{box-sizing:border-box}}body{{margin:0;font-family:Inter,system-ui,sans-serif;background:linear-gradient(135deg,#0d3b18,#1f6b2a 55%,#e8f5e9);color:#fff}}.wrap{{padding:18px 20px 16px;position:relative;overflow:hidden}}.glow{{position:absolute;width:190px;height:190px;border-radius:50%;background:rgba(255,255,255,.08);right:-45px;top:-70px}}.top{{display:flex;justify-content:space-between;gap:14px;align-items:center;position:relative;z-index:1}}.brand{{display:flex;gap:12px;align-items:center}}.logo{{width:48px;height:48px;border-radius:15px;background:rgba(255,255,255,.15);display:flex;align-items:center;justify-content:center;font-size:26px}}.kicker{{font-size:11px;letter-spacing:.13em;text-transform:uppercase;opacity:.8;font-weight:800}}h1{{font-size:22px;margin:2px 0 0;font-weight:850}}.badge{{padding:7px 10px;border-radius:999px;background:rgba(255,255,255,.13);font-size:11px;font-weight:750;white-space:nowrap}}.controls{{display:grid;grid-template-columns:1.1fr 1.1fr 1fr;gap:9px;margin-top:15px;position:relative;z-index:1}}button,select{{border:1px solid rgba(255,255,255,.22);border-radius:11px;padding:10px 11px;background:rgba(255,255,255,.12);color:#fff;font-weight:750;font-size:12px;cursor:pointer;outline:none}}select option{{color:#123;background:#fff}}button:hover{{background:rgba(255,255,255,.2)}}.mic{{background:#fff;color:#176323;border:none;font-size:13px}}.mic.listening{{background:#ffebee;color:#b71c1c;animation:pulse 1.1s infinite}}@keyframes pulse{{50%{{transform:scale(1.03);box-shadow:0 0 0 7px rgba(255,255,255,.12)}}}}.ask{{display:flex;gap:8px;margin-top:10px;position:relative;z-index:1}}input{{flex:1;border:1px solid rgba(255,255,255,.22);border-radius:11px;padding:11px 12px;background:rgba(255,255,255,.12);color:#fff;font-size:13px;outline:none}}input::placeholder{{color:rgba(255,255,255,.68)}}.answer{{margin-top:11px;background:#fff;color:#243127;border-radius:14px;padding:13px 14px;min-height:68px;box-shadow:0 8px 20px rgba(0,0,0,.12);line-height:1.5;font-size:13px;position:relative;z-index:1}}.answer b{{color:#1b5e20}}.quick{{display:flex;gap:7px;flex-wrap:wrap;margin-top:9px;position:relative;z-index:1}}.quick button{{font-size:10px;padding:7px 9px;background:rgba(255,255,255,.1)}}.status{{font-size:10px;opacity:.72;margin-top:8px;position:relative;z-index:1}}@media(max-width:650px){{.controls{{grid-template-columns:1fr}}.badge{{display:none}}}}
</style></head><body><div class="wrap"><div class="glow"></div><div class="top"><div class="brand"><div class="logo">🎙️</div><div><div class="kicker" id="kicker"></div><h1 id="title"></h1></div></div><div class="badge">EN • HI • KN</div></div>
<div class="controls"><select id="lang"><option value="en-IN">English · India</option><option value="hi-IN">हिन्दी</option><option value="kn-IN">ಕನ್ನಡ</option></select><button class="mic" id="mic">🎤 Tap & Speak</button><button id="speak">🔊 Read Answer</button></div>
<div class="ask"><input id="q"><button id="ask">Ask</button></div><div class="quick"><button data-key="how"></button><button data-key="temp"></button><button data-key="business"></button><button data-key="scheme"></button><button data-key="market"></button><button data-key="npk"></button></div>
<div class="answer" id="answer"></div><div class="status" id="status"></div></div><script>
const C={{context:{context_json},lang:'{'en-IN' if language=='English' else 'hi-IN' if language=='Hindi' else 'kn-IN'}'}};
const UI={{
'en-IN':{{kicker:'Gram Sahayak Intelligence',title:'Gram Vaani · AI Voice Assistant',mic:'🎤 Tap & Speak',speak:'🔊 Read Answer',ask:'Ask',placeholder:'Ask about crops, temperature, schemes, loans, markets or business…',how:'How it works',temp:'🌡️ Temperature',business:'💡 Business',scheme:'🏛️ Schemes',market:'📈 Markets',npk:'🌱 NPK',status:'Voice recognition uses your browser speech service when supported. Microphone permission is required.',hello:'<b>Hello! I am Gram Vaani.</b><br>Ask me about farming, markets, schemes, finance, crops, business planning, or your selected location.',listen:'Listening in ',languageSet:'Language set to ',unavailable:'Voice recognition is not available in this browser. Text and read-aloud still work.'}},
'hi-IN':{{kicker:'ग्राम सहायक इंटेलिजेंस',title:'ग्राम वाणी · AI वॉइस असिस्टेंट',mic:'🎤 बोलकर पूछें',speak:'🔊 उत्तर सुनें',ask:'पूछें',placeholder:'फसल, तापमान, योजनाओं, ऋण, बाजार या व्यवसाय के बारे में पूछें…',how:'यह कैसे काम करता है',temp:'🌡️ तापमान',business:'💡 व्यवसाय',scheme:'🏛️ योजनाएँ',market:'📈 बाजार',npk:'🌱 NPK',status:'जहाँ ब्राउज़र सपोर्ट करता है, वहाँ वॉइस सेवा का उपयोग होता है। माइक्रोफ़ोन की अनुमति आवश्यक है।',hello:'<b>नमस्ते! मैं ग्राम वाणी हूँ।</b><br>खेती, बाजार, योजनाओं, वित्त, फसलों, व्यवसाय योजना या आपके स्थान के बारे में पूछें।',listen:'इस भाषा में सुन रहा हूँ: ',languageSet:'भाषा चुनी गई: ',unavailable:'इस ब्राउज़र में वॉइस पहचान उपलब्ध नहीं है। टेक्स्ट और उत्तर सुनाने की सुविधा फिर भी उपलब्ध है।'}},
'kn-IN':{{kicker:'ಗ್ರಾಮ ಸಹಾಯಕ ಇಂಟೆಲಿಜೆನ್ಸ್',title:'ಗ್ರಾಮ ವಾಣಿ · AI ಧ್ವನಿ ಸಹಾಯಕ',mic:'🎤 ಮಾತನಾಡಿ ಕೇಳಿ',speak:'🔊 ಉತ್ತರವನ್ನು ಕೇಳಿ',ask:'ಕೇಳಿ',placeholder:'ಬೆಳೆ, ತಾಪಮಾನ, ಯೋಜನೆಗಳು, ಸಾಲ, ಮಾರುಕಟ್ಟೆ ಅಥವಾ ವ್ಯವಹಾರದ ಬಗ್ಗೆ ಕೇಳಿ…',how:'ಇದು ಹೇಗೆ ಕೆಲಸ ಮಾಡುತ್ತದೆ',temp:'🌡️ ತಾಪಮಾನ',business:'💡 ವ್ಯವಹಾರ',scheme:'🏛️ ಯೋಜನೆಗಳು',market:'📈 ಮಾರುಕಟ್ಟೆ',npk:'🌱 NPK',status:'ಬ್ರೌಸರ್ ಬೆಂಬಲಿಸಿದಾಗ ಧ್ವನಿ ಸೇವೆಯನ್ನು ಬಳಸಲಾಗುತ್ತದೆ. ಮೈಕ್ರೊಫೋನ್ ಅನುಮತಿ ಅಗತ್ಯವಿದೆ.',hello:'<b>ನಮಸ್ಕಾರ! ನಾನು ಗ್ರಾಮ ವಾಣಿ.</b><br>ಕೃಷಿ, ಮಾರುಕಟ್ಟೆ, ಯೋಜನೆಗಳು, ಹಣಕಾಸು, ಬೆಳೆಗಳು, ವ್ಯವಹಾರ ಯೋಜನೆ ಅಥವಾ ನಿಮ್ಮ ಸ್ಥಳದ ಬಗ್ಗೆ ಕೇಳಿ.',listen:'ಈ ಭಾಷೆಯಲ್ಲಿ ಕೇಳಲಾಗುತ್ತಿದೆ: ',languageSet:'ಭಾಷೆ ಆಯ್ಕೆ: ',unavailable:'ಈ ಬ್ರೌಸರ್‌ನಲ್ಲಿ ಧ್ವನಿ ಗುರುತಿಸುವಿಕೆ ಲಭ್ಯವಿಲ್ಲ. ಪಠ್ಯ ಮತ್ತು ಉತ್ತರ ಓದುವಿಕೆ ಇನ್ನೂ ಲಭ್ಯವಿದೆ.'}}
}};
const A={{
'en-IN':{{hello:'Hello! I am Gram Vaani, your multilingual farm and rural-business assistant.',how:'Gram Sahayak starts with one shared location, then connects crop information, market prices, government schemes, financial guidance and business recommendations. The Business page follows Select Business, Enter Inputs, then Strategic Output.',temp:()=>`At ${{C.context.location}}, the location temperature is about ${{C.context.temperature}} degrees Celsius. Source: ${{C.context.temperatureSource}}.`,loc:()=>`Your selected location is ${{C.context.location}}. Its planning water profile is ${{C.context.water}} and the mapped rainfall value is ${{C.context.rainfall}} millimetres.`,business:'Business Recommendation compares resources, capital, market access and location context, then gives an execution roadmap, risk controls, financial benchmarks and related schemes.',scheme:'Government scheme information is grouped by activity. Always verify current official guidelines before applying.',market:'Market Prices is designed to show available mandi information for the selected location. Compare market, quality, transport and buyer deductions before selling.',finance:'Financial Assistant provides planning calculations such as EMI, affordability and cash-flow views. Actual loan terms depend on the lender.',npk:'NPK means Nitrogen, Phosphorus and Potassium. These values can be used with pH, humidity, rainfall and temperature for crop-environment matching.'}},
'hi-IN':{{hello:'नमस्ते! मैं ग्राम वाणी हूँ, आपका बहुभाषी कृषि और ग्रामीण व्यवसाय सहायक।',how:'ग्राम सहायक पहले साझा स्थान लेता है और फिर फसल जानकारी, मंडी भाव, सरकारी योजनाएँ, वित्तीय मार्गदर्शन और व्यवसाय सिफारिशें जोड़ता है। व्यवसाय पेज में व्यवसाय चुनें, जानकारी भरें और रणनीतिक परिणाम देखें।',temp:()=>`आपके स्थान ${{C.context.location}} का तापमान लगभग ${{C.context.temperature}} डिग्री सेल्सियस है। स्रोत: ${{C.context.temperatureSource}}।`,loc:()=>`आपका चुना स्थान ${{C.context.location}} है। पानी की नियोजन स्थिति ${{C.context.water}} और मैप किया गया वर्षा मान ${{C.context.rainfall}} मिलीमीटर है।`,business:'व्यवसाय सिफारिश स्थान, संसाधन, पूंजी और बाजार जानकारी का आकलन करके रोडमैप, जोखिम नियंत्रण, वित्तीय मानदंड और संबंधित योजनाएँ देती है।',scheme:'सरकारी योजनाओं की जानकारी गतिविधि के अनुसार दी जाती है। आवेदन से पहले वर्तमान आधिकारिक दिशानिर्देश अवश्य जाँचें।',market:'मार्केट प्राइस पेज चयनित स्थान की उपलब्ध मंडी जानकारी दिखाने के लिए बनाया गया है। बिक्री से पहले बाजार, गुणवत्ता, परिवहन और खरीदार कटौती की तुलना करें।',finance:'फाइनेंशियल असिस्टेंट EMI, वहनीयता और कैश-फ्लो जैसी योजना गणनाएँ देता है। वास्तविक ऋण शर्तें बैंक पर निर्भर करती हैं।',npk:'NPK का अर्थ नाइट्रोजन, फॉस्फोरस और पोटैशियम है। इन मानों को pH, आर्द्रता, वर्षा और तापमान के साथ फसल-पर्यावरण मिलान में उपयोग किया जा सकता है।'}},
'kn-IN':{{hello:'ನಮಸ್ಕಾರ! ನಾನು ಗ್ರಾಮ ವಾಣಿ. ನಿಮ್ಮ ಬಹುಭಾಷಾ ಕೃಷಿ ಮತ್ತು ಗ್ರಾಮೀಣ ವ್ಯವಹಾರ ಸಹಾಯಕ.',how:'ಗ್ರಾಮ ಸಹಾಯಕ ಮೊದಲು ಹಂಚಿಕೆಯ ಸ್ಥಳವನ್ನು ಬಳಸುತ್ತದೆ. ನಂತರ ಬೆಳೆ ಮಾಹಿತಿ, ಮಾರುಕಟ್ಟೆ ಬೆಲೆ, ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು, ಹಣಕಾಸು ಮಾರ್ಗದರ್ಶನ ಮತ್ತು ವ್ಯವಹಾರ ಶಿಫಾರಸುಗಳನ್ನು ಸಂಪರ್ಕಿಸುತ್ತದೆ. ವ್ಯವಹಾರ ಪುಟದಲ್ಲಿ ವ್ಯವಹಾರ ಆಯ್ಕೆ, ಮಾಹಿತಿ ನಮೂದು ಮತ್ತು ತಂತ್ರಾತ್ಮಕ ಫಲಿತಾಂಶಗಳಿವೆ.',temp:()=>`ನಿಮ್ಮ ಸ್ಥಳ ${{C.context.location}} ನಲ್ಲಿ ತಾಪಮಾನ ಸುಮಾರು ${{C.context.temperature}} ಡಿಗ್ರಿ ಸೆಲ್ಸಿಯಸ್ ಇದೆ. ಮೂಲ: ${{C.context.temperatureSource}}.`,loc:()=>`ನೀವು ಆಯ್ಕೆ ಮಾಡಿದ ಸ್ಥಳ ${{C.context.location}}. ನೀರಿನ ಯೋಜನಾ ಸ್ಥಿತಿ ${{C.context.water}} ಮತ್ತು ಮ್ಯಾಪ್ ಮಾಡಲಾದ ಮಳೆಯ ಪ್ರಮಾಣ ${{C.context.rainfall}} ಮಿಲಿಮೀಟರ್.`,business:'ವ್ಯವಹಾರ ಶಿಫಾರಸು ಸ್ಥಳ, ಸಂಪನ್ಮೂಲ, ಬಂಡವಾಳ ಮತ್ತು ಮಾರುಕಟ್ಟೆ ಮಾಹಿತಿಯನ್ನು ಮೌಲ್ಯಮಾಪನ ಮಾಡಿ ಕಾರ್ಯಯೋಜನೆ, ಅಪಾಯ ನಿಯಂತ್ರಣ, ಹಣಕಾಸು ಮಾನದಂಡಗಳು ಮತ್ತು ಸಂಬಂಧಿತ ಯೋಜನೆಗಳನ್ನು ನೀಡುತ್ತದೆ.',scheme:'ಸರ್ಕಾರಿ ಯೋಜನೆಗಳ ಮಾಹಿತಿಯನ್ನು ಚಟುವಟಿಕೆಯ ಪ್ರಕಾರ ನೀಡಲಾಗುತ್ತದೆ. ಅರ್ಜಿ ಸಲ್ಲಿಸುವ ಮೊದಲು ಪ್ರಸ್ತುತ ಅಧಿಕೃತ ಮಾರ್ಗಸೂಚಿಗಳನ್ನು ಪರಿಶೀಲಿಸಿ.',market:'ಮಾರುಕಟ್ಟೆ ಬೆಲೆ ಪುಟವು ಆಯ್ಕೆ ಮಾಡಿದ ಸ್ಥಳದ ಲಭ್ಯವಿರುವ ಮಂಡಿ ಮಾಹಿತಿಯನ್ನು ತೋರಿಸುತ್ತದೆ. ಮಾರಾಟದ ಮೊದಲು ಮಾರುಕಟ್ಟೆ, ಗುಣಮಟ್ಟ, ಸಾರಿಗೆ ಮತ್ತು ಖರೀದಿದಾರರ ಕಡಿತಗಳನ್ನು ಹೋಲಿಸಿ.',finance:'ಹಣಕಾಸು ಸಹಾಯಕ EMI, ಕೈಗೆಟುಕುವಿಕೆ ಮತ್ತು ನಗದು ಹರಿವಿನ ಯೋಜನಾ ಲೆಕ್ಕಾಚಾರಗಳನ್ನು ನೀಡುತ್ತದೆ. ನಿಜವಾದ ಸಾಲದ ನಿಯಮಗಳು ಸಾಲದಾತನ ಮೇಲೆ ಅವಲಂಬಿತವಾಗಿವೆ.',npk:'NPK ಎಂದರೆ ನೈಟ್ರೋಜನ್, ಫಾಸ್ಫರಸ್ ಮತ್ತು ಪೊಟ್ಯಾಸಿಯಂ. ಈ ಮೌಲ್ಯಗಳನ್ನು pH, ಆರ್ದ್ರತೆ, ಮಳೆ ಮತ್ತು ತಾಪಮಾನದೊಂದಿಗೆ ಬೆಳೆ-ಹವಾಮಾನ ಹೊಂದಾಣಿಕೆಯಲ್ಲಿ ಬಳಸಬಹುದು.'}}
}};
function current(){{return A[C.lang]||A['en-IN']}} function ui(){{return UI[C.lang]||UI['en-IN']}}
function renderUI(){{const u=ui();document.getElementById('kicker').textContent=u.kicker;document.getElementById('title').textContent=u.title;document.getElementById('mic').textContent=u.mic;document.getElementById('speak').textContent=u.speak;document.getElementById('ask').textContent=u.ask;document.getElementById('q').placeholder=u.placeholder;document.getElementById('status').textContent=u.status;document.querySelectorAll('.quick button').forEach(b=>{{const k=b.dataset.key;b.textContent=u[k]}})}}
function answerFor(q){{const x=(q||'').toLowerCase(),a=current();if(!x.trim())return a.hello;if(x.includes('temperature')||x.includes('तापमान')||x.includes('ತಾಪಮಾನ')||x.includes('weather')||x.includes('मौसम')||x.includes('ಹವಾಮಾನ'))return a.temp();if(x.includes('location')||x.includes('स्थान')||x.includes('स्थल')||x.includes('ಸ್ಥಳ'))return a.loc();if(x.includes('business')||x.includes('व्यवसाय')||x.includes('ವ್ಯವಹಾರ')||x.includes('recommend'))return a.business;if(x.includes('scheme')||x.includes('योजना')||x.includes('ಯೋಜನೆ')||x.includes('subsid'))return a.scheme;if(x.includes('market')||x.includes('mandi')||x.includes('मंडी')||x.includes('बाजार')||x.includes('ಮಾರುಕಟ್ಟೆ'))return a.market;if(x.includes('loan')||x.includes('emi')||x.includes('finance')||x.includes('ऋण')||x.includes('कर्ज')||x.includes('ಹಣಕಾಸು')||x.includes('ಸಾಲ'))return a.finance;if(x.includes('npk')||x.includes('nitrogen')||x.includes('नाइट्रोजन')||x.includes('ನೈಟ್ರೋಜನ್'))return a.npk;if(x.includes('how')||x.includes('work')||x.includes('कैसे')||x.includes('काम')||x.includes('ಹೇಗೆ')||x.includes('ಕೆಲಸ'))return a.how;return C.context.page==='Business Recommendation'?a.business:(a.hello+' '+a.how)}}
const q=document.getElementById('q'),ans=document.getElementById('answer'),lang=document.getElementById('lang'),mic=document.getElementById('mic'),speak=document.getElementById('speak'),status=document.getElementById('status');
let voices=[];function loadVoices(){{voices=window.speechSynthesis?window.speechSynthesis.getVoices():[]}}loadVoices();if('speechSynthesis'in window)window.speechSynthesis.onvoiceschanged=loadVoices;
function show(t){{ans.innerHTML=t.replace(/\n/g,'<br>')}}
function chooseVoice(locale){{const target=locale.toLowerCase();let v=voices.find(x=>x.lang.toLowerCase()===target);if(!v)v=voices.find(x=>x.lang.toLowerCase().startsWith(target.split('-')[0]));if(!v&&locale==='kn-IN')v=voices.find(x=>/kannada/i.test(x.name));return v||null}}
function speakKannadaFallback(t){{const url='https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=kn&q='+encodeURIComponent(t);const a=document.getElementById('knAudio')||document.body.appendChild(Object.assign(document.createElement('audio'),{{id:'knAudio',controls:false}}));a.src=url;a.play().catch(()=>{{status.textContent='Kannada voice playback needs a Kannada voice in the browser. Please use Chrome/Edge and allow audio.'}})}}
function speakText(t){{if(!('speechSynthesis'in window)){{if(C.lang==='kn-IN')return speakKannadaFallback(t);status.textContent='Speech synthesis is not supported in this browser.';return}}window.speechSynthesis.cancel();const v=chooseVoice(C.lang);const u=new SpeechSynthesisUtterance(t);u.lang=C.lang;u.rate=.95;u.pitch=1.02;if(v)u.voice=v;u.onerror=()=>{{if(C.lang==='kn-IN')speakKannadaFallback(t)}};if(C.lang==='kn-IN'&&!v){{speakKannadaFallback(t);return}}window.speechSynthesis.speak(u)}}
function askNow(){{const t=answerFor(q.value);show(t);speakText(ans.innerText)}}
document.getElementById('ask').onclick=askNow;speak.onclick=()=>speakText(ans.innerText);
lang.value=C.lang;renderUI();show(current().hello);
lang.onchange=()=>{{C.lang=lang.value;renderUI();show(current().hello);status.textContent=ui().languageSet+lang.options[lang.selectedIndex].text}};
q.addEventListener('keydown',e=>{{if(e.key==='Enter')askNow()}});document.querySelectorAll('.quick button').forEach(b=>b.onclick=()=>{{const k=b.dataset.key;const qmap={{how:'How does Gram Sahayak work?',temp:'What is the temperature at my location?',business:'Tell me about business recommendation',scheme:'Tell me about government schemes',market:'Tell me about market prices',npk:'Explain NPK'}};q.value=qmap[k];askNow()}});
const SR=window.SpeechRecognition||window.webkitSpeechRecognition;if(!SR){{mic.disabled=true;mic.textContent=ui().mic;status.textContent=ui().unavailable}}else{{const r=new SR();r.continuous=false;r.interimResults=false;r.maxAlternatives=1;r.onstart=()=>{{mic.classList.add('listening');mic.textContent='⏹ '+ui().mic.replace('🎤 ','');status.textContent=ui().listen+lang.options[lang.selectedIndex].text+'…'}};r.onend=()=>{{mic.classList.remove('listening');mic.textContent=ui().mic}};r.onerror=e=>{{mic.classList.remove('listening');mic.textContent=ui().mic;status.textContent='Microphone error: '+e.error}};r.onresult=e=>{{q.value=e.results[0][0].transcript;askNow()}};mic.onclick=()=>{{if(mic.classList.contains('listening'))r.stop();else{{r.lang=C.lang;r.start()}}}}}}
</script></body></html>'''
    components.html(html_code, height=405, scrolling=False)
...
HOME_TR = {
 "English": {
  "kicker":"🌱 Agriculture • Information • Guidance","hero1":"Your Digital Companion for Smarter Farming","hero2":"Discover Better Farming Information","hero3":"Make Informed Decisions","text1":"Get useful information about crops, market prices, government schemes and financial guidance — all in one place.","text2":"Explore crop information and practical agricultural guidance through a simple farmer-friendly interface.","text3":"Check available mandi prices, explore schemes and use financial guidance to support your next step.","explore":"✨ Explore Gram Sahayak","explore_note":"Useful tools gathered in one simple farmer-friendly interface.","crop_info":"Crop Information","crop_desc":"Learn about crops and farming practices.","market":"Market Prices","market_desc":"Check the latest available mandi prices.","schemes":"Government Schemes","schemes_desc":"Explore useful government agricultural schemes.","finance":"Financial Assistant","finance_desc":"Get simple financial guidance for farming.","glance":"🌱 Farming at a Glance","glance_note":"A quick overview using information already available in the app.","location":"Location","crop":"Crop","crop_value":"Select in Crop Information","market_price":"Market Price","market_value":"Latest available in Market Prices","scheme_value":"Available in the Government Schemes page","how":"⚙️ How Gram Sahayak Works","how_note":"A location-aware digital farm companion: understand → compare → plan → act, with Gram Vaani available for voice guidance in English, Hindi and Kannada.","s1":"📍 Set Your Location","s1t":"Choose your location once. Gram Sahayak reuses it for climate context, temperature, water profile, market context and business planning.","s2":"🌾 Explore the Right Tool","s2t":"Move between Crop Information, Market Prices, Government Schemes, Financial Assistant and Business Recommendation without repeatedly entering your location.","s3":"🧠 Personalise the Assessment","s3t":"Enter only the relevant details. Business Recommendation adds species/variety/product selection and automatically brings location-based temperature into the assessment.","s4":"📊 Turn Information into Action","s4t":"Receive practical outputs: crop/environment matching, mandi information, scheme discovery, financial planning and business roadmaps with risks and next steps.","s5":"🎙️ Ask Gram Vaani","s5t":"Use the multilingual voice assistant to ask about your location, temperature, crops, markets, schemes, finance or business planning in English, Hindi or Kannada.","seed":"🌱 From Seed to Harvest","grow":"Grow Smarter with Gram Sahayak","growt":"Get crop information, market updates, scheme details and financial guidance to support better farming decisions.","built":"👨‍🌾 Built for Farmers","builtt":"Gram Sahayak brings important agricultural information together in a simple and accessible interface.","checks":["✓ Simple to use","✓ Agricultural information","✓ Latest available mandi prices","✓ Government scheme information","✓ Financial guidance"],"cta":"🌱 Everything you need, in one place.","ctat":"Explore Gram Sahayak and discover useful tools for smarter farming."},
 "Hindi": {
  "kicker":"🌱 कृषि • जानकारी • मार्गदर्शन","hero1":"स्मार्ट खेती के लिए आपका डिजिटल साथी","hero2":"बेहतर कृषि जानकारी खोजें","hero3":"जानकारी के आधार पर निर्णय लें","text1":"फसलों, मंडी भाव, सरकारी योजनाओं और वित्तीय मार्गदर्शन की उपयोगी जानकारी — सब एक जगह।","text2":"सरल किसान-अनुकूल इंटरफेस में फसल जानकारी और व्यावहारिक कृषि मार्गदर्शन देखें।","text3":"उपलब्ध मंडी भाव देखें, योजनाएँ खोजें और अगले कदम के लिए वित्तीय मार्गदर्शन लें।","explore":"✨ ग्राम सहायक को एक्सप्लोर करें","explore_note":"एक सरल किसान-अनुकूल इंटरफेस में उपयोगी उपकरण।","crop_info":"फसल जानकारी","crop_desc":"फसलों और खेती के तरीकों के बारे में जानें।","market":"बाज़ार भाव","market_desc":"उपलब्ध नवीनतम मंडी भाव देखें।","schemes":"सरकारी योजनाएँ","schemes_desc":"उपयोगी सरकारी कृषि योजनाएँ देखें।","finance":"वित्तीय सहायक","finance_desc":"खेती के लिए सरल वित्तीय मार्गदर्शन प्राप्त करें।","glance":"🌱 खेती एक नज़र में","glance_note":"ऐप में पहले से उपलब्ध जानकारी का त्वरित अवलोकन।","location":"स्थान","crop":"फसल","crop_value":"फसल जानकारी में चुनें","market_price":"बाज़ार भाव","market_value":"बाज़ार भाव में उपलब्ध नवीनतम जानकारी","scheme_value":"सरकारी योजनाएँ पेज पर उपलब्ध","how":"⚙️ ग्राम सहायक कैसे काम करता है","how_note":"स्थान-आधारित डिजिटल कृषि साथी: समझें → तुलना करें → योजना बनाएँ → कार्य करें। ग्राम वाणी अंग्रेज़ी, हिंदी और कन्नड़ में वॉइस मार्गदर्शन देता है।","s1":"📍 अपना स्थान चुनें","s1t":"स्थान एक बार चुनें। ग्राम सहायक इसे जलवायु, तापमान, पानी, बाजार और व्यवसाय योजना में दोबारा उपयोग करता है।","s2":"🌾 सही टूल चुनें","s2t":"स्थान दोबारा भरे बिना फसल जानकारी, बाजार भाव, सरकारी योजनाएँ, वित्तीय सहायक और व्यवसाय सिफारिश के बीच जाएँ।","s3":"🧠 आकलन को व्यक्तिगत बनाएँ","s3t":"केवल जरूरी जानकारी भरें। व्यवसाय सिफारिश में प्रजाति/किस्म/उत्पाद चयन और स्थान-आधारित तापमान अपने आप शामिल होता है।","s4":"📊 जानकारी को कार्रवाई में बदलें","s4t":"व्यावहारिक परिणाम पाएँ: फसल/पर्यावरण मिलान, मंडी जानकारी, योजना खोज, वित्तीय योजना और जोखिम सहित व्यवसाय रोडमैप।","s5":"🎙️ ग्राम वाणी से पूछें","s5t":"स्थान, तापमान, फसल, बाजार, योजनाओं, वित्त या व्यवसाय योजना के बारे में अंग्रेज़ी, हिंदी या कन्नड़ में पूछें।","seed":"🌱 बीज से फसल तक","grow":"ग्राम सहायक के साथ स्मार्ट तरीके से बढ़ें","growt":"बेहतर खेती निर्णयों के लिए फसल जानकारी, बाजार अपडेट, योजना विवरण और वित्तीय मार्गदर्शन पाएँ।","built":"👨‍🌾 किसानों के लिए बनाया गया","builtt":"ग्राम सहायक महत्वपूर्ण कृषि जानकारी को सरल और सुलभ इंटरफेस में एक साथ लाता है।","checks":["✓ उपयोग में आसान","✓ कृषि जानकारी","✓ उपलब्ध नवीनतम मंडी भाव","✓ सरकारी योजना जानकारी","✓ वित्तीय मार्गदर्शन"],"cta":"🌱 आपकी ज़रूरत की हर चीज़, एक जगह।","ctat":"ग्राम सहायक देखें और स्मार्ट खेती के उपयोगी टूल खोजें।"},
 "Kannada": {
  "kicker":"🌱 ಕೃಷಿ • ಮಾಹಿತಿ • ಮಾರ್ಗದರ್ಶನ","hero1":"ಸ್ಮಾರ್ಟ್ ಕೃಷಿಗಾಗಿ ನಿಮ್ಮ ಡಿಜಿಟಲ್ ಸಹಾಯಕ","hero2":"ಉತ್ತಮ ಕೃಷಿ ಮಾಹಿತಿಯನ್ನು ಕಂಡುಹಿಡಿಯಿರಿ","hero3":"ಮಾಹಿತಿಯ ಆಧಾರದಲ್ಲಿ ನಿರ್ಧಾರ ತೆಗೆದುಕೊಳ್ಳಿ","text1":"ಬೆಳೆಗಳು, ಮಾರುಕಟ್ಟೆ ಬೆಲೆಗಳು, ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು ಮತ್ತು ಹಣಕಾಸು ಮಾರ್ಗದರ್ಶನದ ಉಪಯುಕ್ತ ಮಾಹಿತಿ — ಒಂದೇ ಸ್ಥಳದಲ್ಲಿ.","text2":"ಸರಳ ರೈತ ಸ್ನೇಹಿ ಇಂಟರ್ಫೇಸ್ ಮೂಲಕ ಬೆಳೆ ಮಾಹಿತಿ ಮತ್ತು ಪ್ರಾಯೋಗಿಕ ಕೃಷಿ ಮಾರ್ಗದರ್ಶನವನ್ನು ಅನ್ವೇಷಿಸಿ.","text3":"ಲಭ್ಯವಿರುವ ಮಂಡಿ ಬೆಲೆಗಳನ್ನು ಪರಿಶೀಲಿಸಿ, ಯೋಜನೆಗಳನ್ನು ನೋಡಿ ಮತ್ತು ಮುಂದಿನ ಹೆಜ್ಜೆಗೆ ಹಣಕಾಸು ಮಾರ್ಗದರ್ಶನ ಬಳಸಿ.","explore":"✨ ಗ್ರಾಮ ಸಹಾಯಕವನ್ನು ಅನ್ವೇಷಿಸಿ","explore_note":"ಸರಳ ರೈತ ಸ್ನೇಹಿ ಇಂಟರ್ಫೇಸ್‌ನಲ್ಲಿ ಉಪಯುಕ್ತ ಸಾಧನಗಳು.","crop_info":"ಬೆಳೆ ಮಾಹಿತಿ","crop_desc":"ಬೆಳೆಗಳು ಮತ್ತು ಕೃಷಿ ವಿಧಾನಗಳ ಬಗ್ಗೆ ತಿಳಿಯಿರಿ.","market":"ಮಾರುಕಟ್ಟೆ ಬೆಲೆಗಳು","market_desc":"ಲಭ್ಯವಿರುವ ಇತ್ತೀಚಿನ ಮಂಡಿ ಬೆಲೆಗಳನ್ನು ಪರಿಶೀಲಿಸಿ.","schemes":"ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು","schemes_desc":"ಉಪಯುಕ್ತ ಸರ್ಕಾರಿ ಕೃಷಿ ಯೋಜನೆಗಳನ್ನು ಅನ್ವೇಷಿಸಿ.","finance":"ಹಣಕಾಸು ಸಹಾಯಕ","finance_desc":"ಕೃಷಿಗಾಗಿ ಸರಳ ಹಣಕಾಸು ಮಾರ್ಗದರ್ಶನ ಪಡೆಯಿರಿ.","glance":"🌱 ಕೃಷಿ ಒಂದು ನೋಟದಲ್ಲಿ","glance_note":"ಆಪ್‌ನಲ್ಲಿ ಈಗಾಗಲೇ ಲಭ್ಯವಿರುವ ಮಾಹಿತಿಯ ತ್ವರಿತ ಅವಲೋಕನ.","location":"ಸ್ಥಳ","crop":"ಬೆಳೆ","crop_value":"ಬೆಳೆ ಮಾಹಿತಿ ವಿಭಾಗದಲ್ಲಿ ಆಯ್ಕೆಮಾಡಿ","market_price":"ಮಾರುಕಟ್ಟೆ ಬೆಲೆ","market_value":"ಮಾರುಕಟ್ಟೆ ಬೆಲೆ ವಿಭಾಗದಲ್ಲಿ ಲಭ್ಯವಿರುವ ಇತ್ತೀಚಿನ ಮಾಹಿತಿ","scheme_value":"ಸರ್ಕಾರಿ ಯೋಜನೆಗಳ ಪುಟದಲ್ಲಿ ಲಭ್ಯ","how":"⚙️ ಗ್ರಾಮ ಸಹಾಯಕ ಹೇಗೆ ಕೆಲಸ ಮಾಡುತ್ತದೆ","how_note":"ಸ್ಥಳಾಧಾರಿತ ಡಿಜಿಟಲ್ ಕೃಷಿ ಸಹಾಯಕ: ಅರ್ಥಮಾಡಿಕೊಳ್ಳಿ → ಹೋಲಿಸಿ → ಯೋಜಿಸಿ → ಕಾರ್ಯಗತಗೊಳಿಸಿ. ಗ್ರಾಮ ವಾಣಿ ಇಂಗ್ಲಿಷ್, ಹಿಂದಿ ಮತ್ತು ಕನ್ನಡದಲ್ಲಿ ಧ್ವನಿ ಮಾರ್ಗದರ್ಶನ ನೀಡುತ್ತದೆ.","s1":"📍 ನಿಮ್ಮ ಸ್ಥಳವನ್ನು ಆಯ್ಕೆಮಾಡಿ","s1t":"ಸ್ಥಳವನ್ನು ಒಮ್ಮೆ ಆಯ್ಕೆಮಾಡಿ. ಗ್ರಾಮ ಸಹಾಯಕ ಅದನ್ನು ಹವಾಮಾನ, ತಾಪಮಾನ, ನೀರು, ಮಾರುಕಟ್ಟೆ ಮತ್ತು ವ್ಯವಹಾರ ಯೋಜನೆಯಲ್ಲಿ ಮರುಬಳಕೆ ಮಾಡುತ್ತದೆ.","s2":"🌾 ಸರಿಯಾದ ಸಾಧನವನ್ನು ಆಯ್ಕೆಮಾಡಿ","s2t":"ಸ್ಥಳವನ್ನು ಮತ್ತೆ ನಮೂದಿಸದೆ ಬೆಳೆ ಮಾಹಿತಿ, ಮಾರುಕಟ್ಟೆ ಬೆಲೆ, ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು, ಹಣಕಾಸು ಸಹಾಯಕ ಮತ್ತು ವ್ಯವಹಾರ ಶಿಫಾರಸುಗಳ ನಡುವೆ ಹೋಗಿ.","s3":"🧠 ಮೌಲ್ಯಮಾಪನವನ್ನು ವೈಯಕ್ತಿಕಗೊಳಿಸಿ","s3t":"ಅಗತ್ಯ ಮಾಹಿತಿಯನ್ನು ಮಾತ್ರ ನಮೂದಿಸಿ. ವ್ಯವಹಾರ ಶಿಫಾರಸಿನಲ್ಲಿ ಜಾತಿ/ತಳಿ/ಉತ್ಪನ್ನ ಆಯ್ಕೆ ಮತ್ತು ಸ್ಥಳಾಧಾರಿತ ತಾಪಮಾನ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಸೇರಿಸಲಾಗುತ್ತದೆ.","s4":"📊 ಮಾಹಿತಿಯನ್ನು ಕಾರ್ಯಗತಗೊಳಿಸಿ","s4t":"ಪ್ರಾಯೋಗಿಕ ಫಲಿತಾಂಶಗಳನ್ನು ಪಡೆಯಿರಿ: ಬೆಳೆ/ಪರಿಸರ ಹೊಂದಾಣಿಕೆ, ಮಂಡಿ ಮಾಹಿತಿ, ಯೋಜನೆ ಹುಡುಕಾಟ, ಹಣಕಾಸು ಯೋಜನೆ ಮತ್ತು ಅಪಾಯಗಳೊಂದಿಗೆ ವ್ಯವಹಾರ ಮಾರ್ಗಸೂಚಿ.","s5":"🎙️ ಗ್ರಾಮ ವಾಣಿಯನ್ನು ಕೇಳಿ","s5t":"ಸ್ಥಳ, ತಾಪಮಾನ, ಬೆಳೆಗಳು, ಮಾರುಕಟ್ಟೆ, ಯೋಜನೆಗಳು, ಹಣಕಾಸು ಅಥವಾ ವ್ಯವಹಾರ ಯೋಜನೆ ಬಗ್ಗೆ ಇಂಗ್ಲಿಷ್, ಹಿಂದಿ ಅಥವಾ ಕನ್ನಡದಲ್ಲಿ ಕೇಳಿ.","seed":"🌱 ಬೀಜದಿಂದ ಕೊಯ್ಲಿನವರೆಗೆ","grow":"ಗ್ರಾಮ ಸಹಾಯಕದೊಂದಿಗೆ ಸ್ಮಾರ್ಟ್ ಆಗಿ ಬೆಳೆಸಿ","growt":"ಉತ್ತಮ ಕೃಷಿ ನಿರ್ಧಾರಗಳಿಗೆ ಬೆಳೆ ಮಾಹಿತಿ, ಮಾರುಕಟ್ಟೆ ನವೀಕರಣಗಳು, ಯೋಜನೆ ವಿವರಗಳು ಮತ್ತು ಹಣಕಾಸು ಮಾರ್ಗದರ್ಶನ ಪಡೆಯಿರಿ.","built":"👨‍🌾 ರೈತರಿಗಾಗಿ ನಿರ್ಮಿಸಲಾಗಿದೆ","builtt":"ಗ್ರಾಮ ಸಹಾಯಕವು ಪ್ರಮುಖ ಕೃಷಿ ಮಾಹಿತಿಯನ್ನು ಸರಳ ಮತ್ತು ಸುಲಭ ಇಂಟರ್ಫೇಸ್‌ನಲ್ಲಿ ಒಟ್ಟುಗೂಡಿಸುತ್ತದೆ.","checks":["✓ ಬಳಸಲು ಸುಲಭ","✓ ಕೃಷಿ ಮಾಹಿತಿ","✓ ಲಭ್ಯವಿರುವ ಇತ್ತೀಚಿನ ಮಂಡಿ ಬೆಲೆಗಳು","✓ ಸರ್ಕಾರಿ ಯೋಜನೆ ಮಾಹಿತಿ","✓ ಹಣಕಾಸು ಮಾರ್ಗದರ್ಶನ"],"cta":"🌱 ನಿಮಗೆ ಬೇಕಾದ ಎಲ್ಲವೂ, ಒಂದೇ ಸ್ಥಳದಲ್ಲಿ.","ctat":"ಗ್ರಾಮ ಸಹಾಯಕವನ್ನು ಅನ್ವೇಷಿಸಿ ಮತ್ತು ಸ್ಮಾರ್ಟ್ ಕೃಷಿಗಾಗಿ ಉಪಯುಕ್ತ ಸಾಧನಗಳನ್ನು ಕಂಡುಹಿಡಿಯಿರಿ."}
}
H=HOME_TR[language]

def _home_t(k): return H.get(k,k)
...
if page == "Home":
    ...
    scenes = [
        {"image":"https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=1500&q=88","title":_home_t("hero1"),"text":_home_t("text1"),"stage":"01 / 03"},
        {"image":"https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=1500&q=88","title":_home_t("hero2"),"text":_home_t("text2"),"stage":"02 / 03"},
        {"image":"https://images.unsplash.com/photo-1488459716781-31db52582fe9?auto=format&fit=crop&w=1500&q=88","title":_home_t("hero3"),"text":_home_t("text3"),"stage":"03 / 03"}
    ]
    ...
    <div class="gs-home">
      <div class="gs-hero">
        <div class="gs-hero-copy">
          <div class="gs-kicker">{_home_t("kicker")}</div>
    ...
    <div id="gs-features" class="gs-section">
      <h2 class="gs-heading">{_home_t("explore")}</h2><p class="gs-note">{_home_t("explore_note")}</p>
      <div class="gs-feature-grid">
        <div class="gs-card"><div class="gs-icon">🌾</div><div class="gs-card-title">{_home_t("crop_info")}</div><div class="gs-card-text">{_home_t("crop_desc")}</div></div>
        <div class="gs-card"><div class="gs-icon">💰</div><div class="gs-card-title">{_home_t("market")}</div><div class="gs-card-text">{_home_t("market_desc")}</div></div>
        <div class="gs-card"><div class="gs-icon">🏛️</div><div class="gs-card-title">{_home_t("schemes")}</div><div class="gs-card-text">{_home_t("schemes_desc")}</div></div>
        <div class="gs-card"><div class="gs-icon">🤖</div><div class="gs-card-title">{_home_t("finance")}</div><div class="gs-card-text">{_home_t("finance_desc")}</div></div>
      </div>
    </div>
    """, unsafe_allow_html=True)

    st.markdown(f"""
    <div id="gs-glance" class="gs-glance gs-section"><h2 class="gs-heading">{_home_t("glance")}</h2><p class="gs-note">{_home_t("glance_note")}</p>
      <div class="gs-glance-grid">
        <div class="gs-glance-item"><div class="gs-glance-icon">📍</div><div class="gs-glance-label">{_home_t("location")}</div><div class="gs-glance-value">{str(location)}</div></div>
        <div class="gs-glance-item"><div class="gs-glance-icon">🌾</div><div class="gs-glance-label">{_home_t("crop")}</div><div class="gs-glance-value">{_home_t("crop_value")}</div></div>
        <div class="gs-glance-item"><div class="gs-glance-icon">💰</div><div class="gs-glance-label">{_home_t("market_price")}</div><div class="gs-glance-value">{_home_t("market_value")}</div></div>
        <div class="gs-glance-item"><div class="gs-glance-icon">🏛️</div><div class="gs-glance-label">{_home_t("schemes")}</div><div class="gs-glance-value">{_home_t("scheme_value")}</div></div>
      </div></div>
    """, unsafe_allow_html=True)

    st.markdown(f"""
    <div id="gs-how" class="gs-how gs-section"><h2 class="gs-heading">{_home_t("how")}</h2><p class="gs-note">{_home_t("how_note")}</p><div class="gs-process">
      <div class="gs-step"><div class="gs-number">1</div><div class="gs-step-title">{_home_t("s1")}</div><div class="gs-step-text">{_home_t("s1t")}</div></div><div class="gs-arrow">→</div>
      <div class="gs-step"><div class="gs-number">2</div><div class="gs-step-title">{_home_t("s2")}</div><div class="gs-step-text">{_home_t("s2t")}</div></div><div class="gs-arrow">→</div>
      <div class="gs-step"><div class="gs-number">3</div><div class="gs-step-title">{_home_t("s3")}</div><div class="gs-step-text">{_home_t("s3t")}</div></div><div class="gs-arrow">→</div>
      <div class="gs-step"><div class="gs-number">4</div><div class="gs-step-title">{_home_t("s4")}</div><div class="gs-step-text">{_home_t("s4t")}</div></div><div class="gs-arrow">→</div>
      <div class="gs-step"><div class="gs-number">5</div><div class="gs-step-title">{_home_t("s5")}</div><div class="gs-step-text">{_home_t("s5t")}</div></div>
    </div></div>
    """, unsafe_allow_html=True)

    st.markdown(f"""
    <div class="gs-motion" id="gs-smart-farming"><div class="gs-gif"><img src="https://media.giphy.com/media/mDBBU8K7Np2UQs9Dqy/giphy.gif" alt="Seedlings growing animation"></div><div>
      <div class="gs-kicker">{_home_t("seed")}</div><h2>{_home_t("grow")}</h2><p>{_home_t("growt")}</p>
      <div class="gs-badges"><span class="gs-badge">🌱 {_home_t("crop_info")}</span><span class="gs-badge">📈 {_home_t("market")}</span><span class="gs-badge">🏛️ {_home_t("schemes")}</span><span class="gs-badge">💰 {_home_t("finance")}</span></div>
    </div></div>
    """, unsafe_allow_html=True)

    checks_html="".join(f"<li>{x}</li>" for x in _home_t("checks"))
    st.markdown(f"""
    <div id="gs-built" class="gs-built gs-section"><div class="gs-built-img"><img src="https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=1200&q=88" alt="Farmer and agricultural produce"></div><div>
      <h2>{_home_t("built")}</h2><p>{_home_t("builtt")}</p><ul class="gs-checks">{checks_html}</ul>
    </div></div>
    """, unsafe_allow_html=True)

    st.markdown(f"""<div class="gs-cta"><h2>{_home_t("cta")}</h2><p>{_home_t("ctat")}</p></div>""", unsafe_allow_html=True)
...
if page == "Market Prices":
    ...
    with key_col:
        market_api_key = st.text_input(
            "🔑 " + tr_any("data.gov.in API key"),
            value=DEFAULT_MANDI_API_KEY,
            type="password",
            key="market_ui_api_key",
            help=tr_any("Enter your free data.gov.in API key to load live mandi prices."),
        )
    with refresh_col:
        if st.button("🔄 " + tr_any("Refresh"), use_container_width=True, key="market_refresh_btn"):
  ...
  <div class="{tag_class}">{tag_text}</div>
        ...
        if missing:
            st.markdown("#### 🕒 " + tr_any("No price reported today"))
            per_row = 3
...
if page == "Financial Assistant":
    ...
    # ========================================================
    with fin_tab3:
        st.markdown("### 📊 " + tr_any("Loan Affordability Calculator"))
        ...
        with ac1:
            aff_principal = st.number_input(
                tr_any("Principal Amount / Loan Amount (₹)"),
                min_value=1000.0,
                value=50000.0,
                step=1000.0,
            ...
            aff_living_exp = st.number_input(
                tr_any("Existing Monthly Living Expenses (₹)"),
                min_value=0.0,
                value=15000.0,
                step=1000.0,
                key="fa_aff_living"
        ...
        with ac2:
            aff_existing_emi = st.number_input(
                tr_any("Existing Monthly Loan EMIs (₹)"),
                min_value=0.0,
                value=2000.0,
                step=500.0,
                key="fa_aff_emi"
            ...
            aff_interest_rate = st.number_input(
                tr_any("Proposed Loan Interest Rate (% p.a.)"),
                min_value=0.0,
                max_value=30.0,
                value=10.0,
                step=0.5,
            ...
            aff_period_years = st.number_input(
                tr_any("Proposed Loan Period (Years)"),
                min_value=1,
                max_value=20,
                value=3,
                step=1,
    ...
    # ========================================================
    with fin_tab4:
        st.markdown("### 💵 " + tr_any("Monthly Cash Flow Planner"))
        ...
        with cf1:
            cf_income = st.number_input(
                tr_any("Expected Monthly Business/Family Income (₹)"),
                min_value=0.0,
                value=35000.0,
                step=1000.0,
                key="fa_cf_income"
            ...
            cf_operating = st.number_input(
                tr_any("Monthly Operating / Business Expenses (₹)"),
                min_value=0.0,
                value=12000.0,
                step=1000.0,
                key="fa_cf_operating"
        ...
        with cf2:
            cf_household = st.number_input(
                tr_any("Monthly Household / Personal Expenses (₹)"),
                min_value=0.0,
                value=14000.0,
                step=1000.0,
                key="fa_cf_household"
            ...
            cf_emis = st.number_input(
                tr_any("Total Monthly Debt / EMI Payments (₹)"),
                min_value=0.0,
                value=3000.0,
                step=500.0,
                key="fa_cf_emis"
