...
_UI_PAIRS = {
    ...
    "Options are filtered using the selected location and climate profile where a mapping is available.": ("विकल्प चयनित स्थान और जलवायु प्रोफ़ाइल के अनुसार फ़िल्टर किए जाते हैं जहाँ मैपिंग उपलब्ध है।", "ಲಭ್ಯವಿರುವ ನಕ್ಷೆಗೆ ಅನುಗುಣವಾಗಿ ಆಯ್ಕೆಗಳನ್ನು ಆಯ್ದ ಸ್ಥಳ ಮತ್ತು ಹವಾಮಾನ ಪ್ರೊಫೈಲ್‌ನೊಂದಿಗೆ ಫಿಲ್ಟರ್ ಮಾಡಲಾಗುತ್ತದೆ."),
    "Species options are prioritised for the selected location and climate; change the selection if you plan a different product.": ("प्रजाति विकल्प चयनित स्थान और जलवायु के लिए प्राथमिकता दिए गए हैं; यदि आप अलग उत्पाद की योजना बनाते हैं तो चयन बदलें।", "ಜಾತಿ ಆಯ್ಕೆಗಳನ್ನು ಆಯ್ದ ಸ್ಥಳ ಮತ್ತು ಹವಾಮಾನಕ್ಕೆ ಆದ್ಯತೆ ನೀಡಲಾಗಿದೆ; ನೀವು ಬೇರೆ ಉತ್ಪನ್ನ ಯೋಜಿಸಿದರೆ ಆಯ್ಕೆಯನ್ನು ಬದಲಾಯಿಸಿ."),
    "Schemes": ("योजनाएँ", "ಯೋಜನೆಗಳು"),
    "Finance": ("वित्त", "ಹಣಕಾಸು"),
    "Business": ("व्यवसाय", "ವ್ಯವಹಾರ"),
...
def _page_label(page_key):
    """Return a fully translated navigation label for the active language."""
    icons = {
        "Home": "\U0001F3E0",
        "Market Prices": "\U0001F4C8",
        "Government Schemes": "\U0001F3DB\uFE0F",
        "Financial Assistant": "\U0001F4B0",
        "Business Recommendation": "\U0001F4A1",
    }
    short = {
        "Home": "Home",
    ...
    return f"{icons.get(page_key, '')} {tr_any(short.get(page_key, page_key))}"
...
CROP_IMAGE = {
    'Areca nut': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2252%22%20rx%3D%2216%22%20ry%3D%2222%22%20fill%3D%22%23A1887F%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2252%22%20rx%3D%2210%22%20ry%3D%2214%22%20fill%3D%22%238D6E63%22%20opacity%3D%22.4%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2030v8%22%20stroke%3D%22%235D4037%22%20stroke-width%3D%223%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Bajra': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF8E1%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2242%22%20rx%3D%2212%22%20ry%3D%2224%22%20fill%3D%22%23A1887F%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2066v12%22%20stroke%3D%22%236D4C41%22%20stroke-width%3D%223%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%23795548%22%3E%3Ccircle%20cx%3D%2244%22%20cy%3D%2234%22%20r%3D%221.8%22/%3E%3Ccircle%20cx%3D%2252%22%20cy%3D%2238%22%20r%3D%221.8%22/%3E%3Ccircle%20cx%3D%2246%22%20cy%3D%2246%22%20r%3D%221.8%22/%3E%3Ccircle%20cx%3D%2250%22%20cy%3D%2252%22%20r%3D%221.8%22/%3E%3C/g%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Banana': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF9C4%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFE082%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M28%2030c8%202%2020%2028%2014%2044-10%204-20-12-18-30%201-6%202-12%204-14z%22%20fill%3D%22%23FDD835%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M40%2028c10%204%2022%2030%2012%2046-8%202-16-16-14-34%201-6%201-10%202-12z%22%20fill%3D%22%23FBC02D%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M50%2030c8%206%2016%2028%206%2042-6%202-12-14-10-30%201-5%202-10%204-12z%22%20fill%3D%22%23F9A825%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Beans': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2236%22%20cy%3D%2248%22%20rx%3D%2210%22%20ry%3D%2222%22%20fill%3D%22%237CB342%22%20transform%3D%22rotate%28-25%2036%2048%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2252%22%20cy%3D%2250%22%20rx%3D%2210%22%20ry%3D%2222%22%20fill%3D%22%238BC34A%22%20transform%3D%22rotate%2815%2052%2050%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2264%22%20cy%3D%2246%22%20rx%3D%228%22%20ry%3D%2218%22%20fill%3D%22%239CCC65%22%20transform%3D%22rotate%2835%2064%2046%29%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Bengal Gram': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2248%22%20r%3D%2214%22%20fill%3D%22%23D4A574%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2258%22%20cy%3D%2250%22%20r%3D%2214%22%20fill%3D%22%23C9995A%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2248%22%20r%3D%224%22%20fill%3D%22%23A67C52%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2258%22%20cy%3D%2250%22%20r%3D%224%22%20fill%3D%22%23A67C52%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Black Gram': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23EFEBE9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23D7CCC8%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2240%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%2216%22%20fill%3D%22%23424242%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2256%22%20cy%3D%2250%22%20rx%3D%2212%22%20ry%3D%2216%22%20fill%3D%22%23212121%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Black Pepper': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFCDD2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23EF9A9A%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2244%22%20r%3D%228%22%20fill%3D%22%23212121%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2256%22%20cy%3D%2244%22%20r%3D%228%22%20fill%3D%22%23424242%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2258%22%20r%3D%228%22%20fill%3D%22%23212121%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2236%22%20cy%3D%2260%22%20r%3D%227%22%20fill%3D%22%23616161%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2260%22%20cy%3D%2258%22%20r%3D%227%22%20fill%3D%22%23424242%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Brinjal': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E1BEE7%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23CE93D8%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2256%22%20rx%3D%2218%22%20ry%3D%2226%22%20fill%3D%22%236A1B9A%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2256%22%20rx%3D%2210%22%20ry%3D%2216%22%20fill%3D%22%234A148C%22%20opacity%3D%22.35%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M40%2032c6-8%2016-8%2016%202%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2230%22%20rx%3D%2210%22%20ry%3D%225%22%20fill%3D%22%2343A047%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Cabbage': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2250%22%20r%3D%2228%22%20fill%3D%22%2366BB6A%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2250%22%20r%3D%2218%22%20fill%3D%22%2381C784%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2250%22%20r%3D%2210%22%20fill%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M30%2042c8%204%2020%204%2028%200M30%2058c8-4%2020-4%2028%200%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%222%22%20fill%3D%22none%22%20opacity%3D%22.5%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Capsicum': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M34%2040c0-10%208-16%2014-16s14%206%2014%2016c2%2020-4%2036-14%2036s-16-16-14-36z%22%20fill%3D%22%2343A047%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M42%2026c4-6%2010-4%2010%202%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2224%22%20rx%3D%228%22%20ry%3D%224%22%20fill%3D%22%2366BB6A%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Cardamom': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2240%22%20cy%3D%2250%22%20rx%3D%2210%22%20ry%3D%2218%22%20fill%3D%22%2381C784%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2256%22%20cy%3D%2248%22%20rx%3D%2210%22%20ry%3D%2218%22%20fill%3D%22%2366BB6A%22/%3E%0A%20%20%20%20%20%20%3Cline%20x1%3D%2240%22%20y1%3D%2240%22%20x2%3D%2240%22%20y2%3D%2260%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%20%20%20%20%3Cline%20x1%3D%2256%22%20y1%3D%2238%22%20x2%3D%2256%22%20y2%3D%2258%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Carrot': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2030c12%208%2016%2040%200%2052-16-12-12-44%200-52z%22%20fill%3D%22%23EF6C00%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M42%2028c2-10%2012-10%2014%200%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22%20fill%3D%22%2366BB6A%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Cashew': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M40%2060c-8-4-8-18%202-22%208-2%2014%204%2012%2012-2%208-8%2012-14%2010z%22%20fill%3D%22%23D4A574%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M52%2040c6-12%2018-8%2016%204-1%208-10%2012-16%208%22%20fill%3D%22%23E53935%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Cauliflower': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E8F5E9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2248%22%20r%3D%2212%22%20fill%3D%22%23F5F5F5%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2256%22%20cy%3D%2248%22%20r%3D%2212%22%20fill%3D%22%23FAFAFA%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2240%22%20r%3D%2212%22%20fill%3D%22%23EEEEEE%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2256%22%20r%3D%2212%22%20fill%3D%22%23F5F5F5%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M36%2064c4%208%2020%208%2024%200%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%224%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Chilli': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFCDD2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23EF9A9A%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M52%2028c2%204%2014%2028%208%2044-8%2010-20-6-16-24%202-10%206-18%208-20z%22%20fill%3D%22%23E53935%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M50%2024c4-6%2010-2%208%206%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2254%22%20cy%3D%2222%22%20rx%3D%225%22%20ry%3D%223%22%20fill%3D%22%2343A047%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Chrysanthemum': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF8E1%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFECB3%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%228%22%20fill%3D%22%23FF8F00%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%23FFC107%22%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2228%22%20rx%3D%225%22%20ry%3D%2214%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2268%22%20rx%3D%225%22%20ry%3D%2214%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2228%22%20cy%3D%2248%22%20rx%3D%2214%22%20ry%3D%225%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2268%22%20cy%3D%2248%22%20rx%3D%2214%22%20ry%3D%225%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2234%22%20cy%3D%2234%22%20rx%3D%2212%22%20ry%3D%225%22%20transform%3D%22rotate%28-45%2034%2034%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2262%22%20cy%3D%2234%22%20rx%3D%2212%22%20ry%3D%225%22%20transform%3D%22rotate%2845%2062%2034%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2234%22%20cy%3D%2262%22%20rx%3D%2212%22%20ry%3D%225%22%20transform%3D%22rotate%2845%2034%2062%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2262%22%20cy%3D%2262%22%20rx%3D%2212%22%20ry%3D%225%22%20transform%3D%22rotate%28-45%2062%2062%29%22/%3E%0A%20%20%20%20%20%20%3C/g%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Coconut': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23EFEBE9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23D7CCC8%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2252%22%20r%3D%2224%22%20fill%3D%22%236D4C41%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2252%22%20r%3D%2218%22%20fill%3D%22%238D6E63%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2246%22%20r%3D%223%22%20fill%3D%22%235D4037%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2252%22%20cy%3D%2244%22%20r%3D%223%22%20fill%3D%22%235D4037%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2256%22%20r%3D%223%22%20fill%3D%22%235D4037%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Coffee': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23EFEBE9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23D7CCC8%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2242%22%20cy%3D%2250%22%20rx%3D%2212%22%20ry%3D%2216%22%20fill%3D%22%235D4037%22%20transform%3D%22rotate%28-20%2042%2050%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2256%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%2216%22%20fill%3D%22%234E342E%22%20transform%3D%22rotate%2815%2056%2048%29%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2034c4-8%2012-4%208%204%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Coriander': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2240%22%20r%3D%228%22%20fill%3D%22%2366BB6A%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2236%22%20cy%3D%2250%22%20r%3D%228%22%20fill%3D%22%2381C784%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2260%22%20cy%3D%2250%22%20r%3D%228%22%20fill%3D%22%2381C784%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2242%22%20cy%3D%2260%22%20r%3D%227%22%20fill%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2254%22%20cy%3D%2260%22%20r%3D%227%22%20fill%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2070V48%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%222%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Cotton': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E3F2FD%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23BBDEFB%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%2220%22%20fill%3D%22%23FAFAFA%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2242%22%20r%3D%228%22%20fill%3D%22%23F5F5F5%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2256%22%20cy%3D%2242%22%20r%3D%228%22%20fill%3D%22%23EEEEEE%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2256%22%20r%3D%228%22%20fill%3D%22%23F5F5F5%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2068v10%22%20stroke%3D%22%2366BB6A%22%20stroke-width%3D%223%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Cucumber': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2250%22%20rx%3D%2214%22%20ry%3D%2230%22%20fill%3D%22%237CB342%22%20transform%3D%22rotate%28-20%2048%2050%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2250%22%20rx%3D%228%22%20ry%3D%2220%22%20fill%3D%22%239CCC65%22%20opacity%3D%22.4%22%20transform%3D%22rotate%28-20%2048%2050%29%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Flowers': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FCE4EC%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23F8BBD0%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%228%22%20fill%3D%22%23F9A825%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%23EC407A%22%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2228%22%20rx%3D%227%22%20ry%3D%2212%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2268%22%20rx%3D%227%22%20ry%3D%2212%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2228%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%227%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2268%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%227%22/%3E%0A%20%20%20%20%20%20%3C/g%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Garlic': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23F5F5F5%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23E0E0E0%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2254%22%20rx%3D%2220%22%20ry%3D%2222%22%20fill%3D%22%23FAFAFA%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2032v44M36%2040c4%208%204%2020%200%2028M60%2040c-4%208-4%2020%200%2028%22%20stroke%3D%22%23BDBDBD%22%20stroke-width%3D%222%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M42%2028c2-6%2010-6%2012%200%22%20stroke%3D%22%239E9E9E%22%20stroke-width%3D%222%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Gerbera': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FCE4EC%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23F8BBD0%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%2210%22%20fill%3D%22%235D4037%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%23E91E63%22%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2226%22%20rx%3D%227%22%20ry%3D%2214%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2270%22%20rx%3D%227%22%20ry%3D%2214%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2226%22%20cy%3D%2248%22%20rx%3D%2214%22%20ry%3D%227%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2270%22%20cy%3D%2248%22%20rx%3D%2214%22%20ry%3D%227%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2232%22%20cy%3D%2232%22%20rx%3D%2212%22%20ry%3D%226%22%20transform%3D%22rotate%28-45%2032%2032%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2264%22%20cy%3D%2232%22%20rx%3D%2212%22%20ry%3D%226%22%20transform%3D%22rotate%2845%2064%2032%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2232%22%20cy%3D%2264%22%20rx%3D%2212%22%20ry%3D%226%22%20transform%3D%22rotate%2845%2032%2064%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2264%22%20cy%3D%2264%22%20rx%3D%2212%22%20ry%3D%226%22%20transform%3D%22rotate%28-45%2064%2064%29%22/%3E%0A%20%20%20%20%20%20%3C/g%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Ginger': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2236%22%20cy%3D%2250%22%20rx%3D%2212%22%20ry%3D%2216%22%20fill%3D%22%23D7A86E%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2252%22%20cy%3D%2246%22%20rx%3D%2214%22%20ry%3D%2214%22%20fill%3D%22%23C9995A%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2262%22%20cy%3D%2256%22%20rx%3D%2210%22%20ry%3D%2212%22%20fill%3D%22%23B88B4A%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Grapes': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E1BEE7%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23CE93D8%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2244%22%20r%3D%229%22%20fill%3D%22%237B1FA2%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2254%22%20cy%3D%2244%22%20r%3D%229%22%20fill%3D%22%238E24AA%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2234%22%20cy%3D%2256%22%20r%3D%229%22%20fill%3D%22%236A1B9A%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2256%22%20r%3D%229%22%20fill%3D%22%237B1FA2%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2260%22%20cy%3D%2256%22%20r%3D%229%22%20fill%3D%22%238E24AA%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2268%22%20r%3D%228%22%20fill%3D%22%236A1B9A%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2028v12%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Green Chilli': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M52%2028c2%204%2014%2028%208%2044-8%2010-20-6-16-24%202-10%206-18%208-20z%22%20fill%3D%22%2343A047%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M50%2024c4-6%2010-2%208%206%22%20stroke%3D%22%231B5E20%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2254%22%20cy%3D%2222%22%20rx%3D%225%22%20ry%3D%223%22%20fill%3D%22%232E7D32%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Green Gram': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2240%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%2216%22%20fill%3D%22%239CCC65%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2256%22%20cy%3D%2250%22%20rx%3D%2212%22%20ry%3D%2216%22%20fill%3D%22%238BC34A%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Groundnut': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2238%22%20cy%3D%2250%22%20rx%3D%2214%22%20ry%3D%2218%22%20fill%3D%22%23D7A86E%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2258%22%20cy%3D%2250%22%20rx%3D%2214%22%20ry%3D%2218%22%20fill%3D%22%23C9995A%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2040v20%22%20stroke%3D%22%23A67C52%22%20stroke-width%3D%222%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Guava': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2252%22%20r%3D%2224%22%20fill%3D%22%239CCC65%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2252%22%20r%3D%2214%22%20fill%3D%22%23AED581%22%20opacity%3D%22.5%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M42%2028c4-8%2012-6%2010%204%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2226%22%20rx%3D%228%22%20ry%3D%224%22%20fill%3D%22%2366BB6A%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Jasmine': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FAFAFA%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23F5F5F5%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%228%22%20fill%3D%22%23FFF9C4%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%23FAFAFA%22%20stroke%3D%22%23E0E0E0%22%20stroke-width%3D%221%22%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2230%22%20rx%3D%227%22%20ry%3D%2212%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2266%22%20rx%3D%227%22%20ry%3D%2212%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2230%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%227%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2266%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%227%22/%3E%0A%20%20%20%20%20%20%3C/g%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Jowar': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF8E1%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2244%22%20rx%3D%2214%22%20ry%3D%2222%22%20fill%3D%22%23FFB74D%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2066v12%22%20stroke%3D%22%238D6E63%22%20stroke-width%3D%223%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%23F57C00%22%3E%3Ccircle%20cx%3D%2244%22%20cy%3D%2236%22%20r%3D%222%22/%3E%3Ccircle%20cx%3D%2252%22%20cy%3D%2240%22%20r%3D%222%22/%3E%3Ccircle%20cx%3D%2246%22%20cy%3D%2248%22%20r%3D%222%22/%3E%3Ccircle%20cx%3D%2252%22%20cy%3D%2252%22%20r%3D%222%22/%3E%3C/g%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Lady Finger': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2250%22%20rx%3D%2212%22%20ry%3D%2228%22%20fill%3D%22%238BC34A%22%20transform%3D%22rotate%28-10%2048%2050%29%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2024c4-6%2010%200%206%206%22%20stroke%3D%22%23558B2F%22%20stroke-width%3D%222%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cline%20x1%3D%2242%22%20y1%3D%2240%22%20x2%3D%2254%22%20y2%3D%2242%22%20stroke%3D%22%23689F38%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%20%20%20%20%3Cline%20x1%3D%2242%22%20y1%3D%2252%22%20x2%3D%2254%22%20y2%3D%2254%22%20stroke%3D%22%23689F38%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Maize': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF9C4%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFE082%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2252%22%20rx%3D%2216%22%20ry%3D%2228%22%20fill%3D%22%23FDD835%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%23F9A825%22%3E%0A%20%20%20%20%20%20%20%20%3Ccircle%20cx%3D%2242%22%20cy%3D%2240%22%20r%3D%222%22/%3E%3Ccircle%20cx%3D%2254%22%20cy%3D%2240%22%20r%3D%222%22/%3E%0A%20%20%20%20%20%20%20%20%3Ccircle%20cx%3D%2242%22%20cy%3D%2250%22%20r%3D%222%22/%3E%3Ccircle%20cx%3D%2254%22%20cy%3D%2250%22%20r%3D%222%22/%3E%0A%20%20%20%20%20%20%20%20%3Ccircle%20cx%3D%2242%22%20cy%3D%2260%22%20r%3D%222%22/%3E%3Ccircle%20cx%3D%2254%22%20cy%3D%2260%22%20r%3D%222%22/%3E%0A%20%20%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2245%22%20r%3D%222%22/%3E%3Ccircle%20cx%3D%2248%22%20cy%3D%2255%22%20r%3D%222%22/%3E%0A%20%20%20%20%20%20%3C/g%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M40%2028c4-10%2012-10%2016%200%22%20stroke%3D%22%2343A047%22%20stroke-width%3D%223%22%20fill%3D%22%2366BB6A%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Mango': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2250%22%20cy%3D%2254%22%20rx%3D%2222%22%20ry%3D%2226%22%20fill%3D%22%23FFB300%22%20transform%3D%22rotate%28-20%2050%2054%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2250%22%20cy%3D%2254%22%20rx%3D%2212%22%20ry%3D%2216%22%20fill%3D%22%23FF8F00%22%20opacity%3D%22.3%22%20transform%3D%22rotate%28-20%2050%2054%29%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M42%2028c6-8%2014-4%2012%206%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%224%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2226%22%20rx%3D%228%22%20ry%3D%224%22%20fill%3D%22%2343A047%22%20transform%3D%22rotate%28-30%2048%2026%29%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Marigold': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF3E0%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%2210%22%20fill%3D%22%23EF6C00%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%23FFA726%22%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2228%22%20rx%3D%227%22%20ry%3D%2212%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2268%22%20rx%3D%227%22%20ry%3D%2212%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2228%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%227%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2268%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%227%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2234%22%20cy%3D%2234%22%20rx%3D%2210%22%20ry%3D%226%22%20transform%3D%22rotate%28-45%2034%2034%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2262%22%20cy%3D%2234%22%20rx%3D%2210%22%20ry%3D%226%22%20transform%3D%22rotate%2845%2062%2034%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2234%22%20cy%3D%2262%22%20rx%3D%2210%22%20ry%3D%226%22%20transform%3D%22rotate%2845%2034%2062%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2262%22%20cy%3D%2262%22%20rx%3D%2210%22%20ry%3D%226%22%20transform%3D%22rotate%28-45%2062%2062%29%22/%3E%0A%20%20%20%20%20%20%3C/g%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Mulberry': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E1BEE7%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23CE93D8%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2244%22%20r%3D%2210%22%20fill%3D%22%237B1FA2%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2254%22%20cy%3D%2244%22%20r%3D%2210%22%20fill%3D%22%238E24AA%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2256%22%20r%3D%2210%22%20fill%3D%22%236A1B9A%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2028v12%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Onion': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E1BEE7%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23CE93D8%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2258%22%20rx%3D%2222%22%20ry%3D%2224%22%20fill%3D%22%23AB47BC%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2258%22%20rx%3D%2214%22%20ry%3D%2216%22%20fill%3D%22%238E24AA%22%20opacity%3D%22.35%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M40%2036c3-10%2013-10%2016%200%22%20stroke%3D%22%237B1FA2%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2018v16%22%20stroke%3D%22%2366BB6A%22%20stroke-width%3D%223%22%20stroke-linecap%3D%22round%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Orange': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2250%22%20r%3D%2226%22%20fill%3D%22%23FF9800%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2250%22%20r%3D%2218%22%20fill%3D%22%23FB8C00%22%20opacity%3D%22.3%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M42%2026c4-6%2012-4%2010%204%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2224%22%20rx%3D%227%22%20ry%3D%223%22%20fill%3D%22%2343A047%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Paddy': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E8F5E9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2078V30%22%20stroke%3D%22%238D6E63%22%20stroke-width%3D%222%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2242%22%20cy%3D%2238%22%20rx%3D%225%22%20ry%3D%229%22%20fill%3D%22%23FFECB3%22%20transform%3D%22rotate%28-25%2042%2038%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2254%22%20cy%3D%2238%22%20rx%3D%225%22%20ry%3D%229%22%20fill%3D%22%23FFE082%22%20transform%3D%22rotate%2825%2054%2038%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2242%22%20cy%3D%2252%22%20rx%3D%225%22%20ry%3D%229%22%20fill%3D%22%23FFECB3%22%20transform%3D%22rotate%28-25%2042%2052%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2254%22%20cy%3D%2252%22%20rx%3D%225%22%20ry%3D%229%22%20fill%3D%22%23FFE082%22%20transform%3D%22rotate%2825%2054%2052%29%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Papaya': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2252%22%20rx%3D%2220%22%20ry%3D%2226%22%20fill%3D%22%23FF9800%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2252%22%20rx%3D%2212%22%20ry%3D%2216%22%20fill%3D%22%23FB8C00%22%20opacity%3D%22.4%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M42%2028c4-8%2012-8%2012%202%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Pepper': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFCDD2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23EF9A9A%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2244%22%20r%3D%228%22%20fill%3D%22%23212121%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2256%22%20cy%3D%2244%22%20r%3D%228%22%20fill%3D%22%23424242%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2258%22%20r%3D%228%22%20fill%3D%22%23212121%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2236%22%20cy%3D%2260%22%20r%3D%227%22%20fill%3D%22%23616161%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2260%22%20cy%3D%2258%22%20r%3D%227%22%20fill%3D%22%23424242%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Pomegranate': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFCDD2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23EF9A9A%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2254%22%20r%3D%2224%22%20fill%3D%22%23C62828%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M40%2030c4-8%2012-8%2016%200l-4%208h-8z%22%20fill%3D%22%23E53935%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2252%22%20r%3D%223%22%20fill%3D%22%23FF8A80%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2256%22%20cy%3D%2250%22%20r%3D%223%22%20fill%3D%22%23FF8A80%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2260%22%20r%3D%223%22%20fill%3D%22%23FF8A80%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Potato': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23D7CCC8%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23BCAAA4%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2250%22%20rx%3D%2228%22%20ry%3D%2222%22%20fill%3D%22%23A1887F%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2236%22%20cy%3D%2246%22%20r%3D%223%22%20fill%3D%22%236D4C41%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2256%22%20cy%3D%2254%22%20r%3D%222.5%22%20fill%3D%22%236D4C41%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2242%22%20r%3D%222%22%20fill%3D%22%236D4C41%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Ragi': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23EFEBE9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23D7CCC8%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%2222%22%20fill%3D%22%236D4C41%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%235D4037%22%3E%0A%20%20%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2242%22%20r%3D%223%22/%3E%3Ccircle%20cx%3D%2256%22%20cy%3D%2242%22%20r%3D%223%22/%3E%0A%20%20%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2254%22%20r%3D%223%22/%3E%3Ccircle%20cx%3D%2256%22%20cy%3D%2254%22%20r%3D%223%22/%3E%0A%20%20%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%223%22/%3E%0A%20%20%20%20%20%20%3C/g%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Rice': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E8F5E9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2078V30%22%20stroke%3D%22%238D6E63%22%20stroke-width%3D%222%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2242%22%20cy%3D%2238%22%20rx%3D%225%22%20ry%3D%229%22%20fill%3D%22%23FFECB3%22%20transform%3D%22rotate%28-25%2042%2038%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2254%22%20cy%3D%2238%22%20rx%3D%225%22%20ry%3D%229%22%20fill%3D%22%23FFE082%22%20transform%3D%22rotate%2825%2054%2038%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2242%22%20cy%3D%2252%22%20rx%3D%225%22%20ry%3D%229%22%20fill%3D%22%23FFECB3%22%20transform%3D%22rotate%28-25%2042%2052%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2254%22%20cy%3D%2252%22%20rx%3D%225%22%20ry%3D%229%22%20fill%3D%22%23FFE082%22%20transform%3D%22rotate%2825%2054%2052%29%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Rose': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FCE4EC%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23F8BBD0%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%2210%22%20fill%3D%22%23E91E63%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2234%22%20rx%3D%228%22%20ry%3D%2212%22%20fill%3D%22%23EC407A%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2262%22%20rx%3D%228%22%20ry%3D%2212%22%20fill%3D%22%23EC407A%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2234%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%228%22%20fill%3D%22%23F06292%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2262%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%228%22%20fill%3D%22%23F06292%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Rubber': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2240%22%20rx%3D%2222%22%20ry%3D%2214%22%20fill%3D%22%2366BB6A%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2040v36%22%20stroke%3D%22%238D6E63%22%20stroke-width%3D%224%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2272%22%20rx%3D%2210%22%20ry%3D%226%22%20fill%3D%22%23A1887F%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Soybean': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E8F5E9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2236%22%20cy%3D%2250%22%20rx%3D%2212%22%20ry%3D%2218%22%20fill%3D%22%23AED581%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2256%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%2218%22%20fill%3D%22%239CCC65%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2236%22%20cy%3D%2250%22%20r%3D%223%22%20fill%3D%22%23558B2F%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2256%22%20cy%3D%2248%22%20r%3D%223%22%20fill%3D%22%23558B2F%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Spinach': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2236%22%20cy%3D%2248%22%20rx%3D%2214%22%20ry%3D%2222%22%20fill%3D%22%2366BB6A%22%20transform%3D%22rotate%28-25%2036%2048%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2256%22%20cy%3D%2246%22%20rx%3D%2214%22%20ry%3D%2222%22%20fill%3D%22%2343A047%22%20transform%3D%22rotate%2820%2056%2046%29%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2070V40%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%223%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Sugarcane': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Crect%20x%3D%2240%22%20y%3D%2220%22%20width%3D%2216%22%20height%3D%2256%22%20rx%3D%226%22%20fill%3D%22%237CB342%22/%3E%0A%20%20%20%20%20%20%3Cline%20x1%3D%2240%22%20y1%3D%2236%22%20x2%3D%2256%22%20y2%3D%2236%22%20stroke%3D%22%23558B2F%22%20stroke-width%3D%222%22/%3E%0A%20%20%20%20%20%20%3Cline%20x1%3D%2240%22%20y1%3D%2250%22%20x2%3D%2256%22%20y2%3D%2250%22%20stroke%3D%22%23558B2F%22%20stroke-width%3D%222%22/%3E%0A%20%20%20%20%20%20%3Cline%20x1%3D%2240%22%20y1%3D%2264%22%20x2%3D%2256%22%20y2%3D%2264%22%20stroke%3D%22%23558B2F%22%20stroke-width%3D%222%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M42%2022c-8-8%200-14%208-8%22%20fill%3D%22%2381C784%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Sunflower': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF9C4%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFE082%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2248%22%20r%3D%2212%22%20fill%3D%22%235D4037%22/%3E%0A%20%20%20%20%20%20%3Cg%20fill%3D%22%23FDD835%22%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2224%22%20rx%3D%226%22%20ry%3D%2212%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2272%22%20rx%3D%226%22%20ry%3D%2212%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2224%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%226%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2272%22%20cy%3D%2248%22%20rx%3D%2212%22%20ry%3D%226%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2230%22%20cy%3D%2230%22%20rx%3D%2210%22%20ry%3D%226%22%20transform%3D%22rotate%28-45%2030%2030%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2266%22%20cy%3D%2230%22%20rx%3D%2210%22%20ry%3D%226%22%20transform%3D%22rotate%2845%2066%2030%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2230%22%20cy%3D%2266%22%20rx%3D%2210%22%20ry%3D%226%22%20transform%3D%22rotate%2845%2030%2066%29%22/%3E%0A%20%20%20%20%20%20%20%20%3Cellipse%20cx%3D%2266%22%20cy%3D%2266%22%20rx%3D%2210%22%20ry%3D%226%22%20transform%3D%22rotate%28-45%2066%2066%29%22/%3E%0A%20%20%20%20%20%20%3C/g%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Tobacco': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23A5D6A7%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2248%22%20rx%3D%2220%22%20ry%3D%2228%22%20fill%3D%22%237CB342%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2024v48%22%20stroke%3D%22%23558B2F%22%20stroke-width%3D%222%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M36%2040c8%204%2016%204%2024%200M36%2056c8%204%2016%204%2024%200%22%20stroke%3D%22%23558B2F%22%20stroke-width%3D%221.5%22%20fill%3D%22none%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Tomato': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFCDD2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23EF9A9A%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2254%22%20r%3D%2226%22%20fill%3D%22%23E53935%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2254%22%20rx%3D%2210%22%20ry%3D%226%22%20fill%3D%22%23C62828%22%20opacity%3D%22.35%22/%3E%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M40%2032c4-8%2012-8%2016%200%22%20stroke%3D%22%232E7D32%22%20stroke-width%3D%224%22%20fill%3D%22none%22%20stroke-linecap%3D%22round%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2248%22%20cy%3D%2230%22%20r%3D%224%22%20fill%3D%22%2343A047%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Tur': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE0B2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFCC80%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2240%22%20cy%3D%2248%22%20rx%3D%2211%22%20ry%3D%2218%22%20fill%3D%22%23D7A86E%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2256%22%20cy%3D%2250%22%20rx%3D%2211%22%20ry%3D%2218%22%20fill%3D%22%23C9995A%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2240%22%20cy%3D%2248%22%20r%3D%223%22%20fill%3D%22%238D6E63%22/%3E%0A%20%20%20%20%20%20%3Ccircle%20cx%3D%2256%22%20cy%3D%2250%22%20r%3D%223%22%20fill%3D%22%238D6E63%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Turmeric': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF9C4%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFE082%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2240%22%20cy%3D%2252%22%20rx%3D%2210%22%20ry%3D%2222%22%20fill%3D%22%23F9A825%22%20transform%3D%22rotate%28-15%2040%2052%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2256%22%20cy%3D%2250%22%20rx%3D%2210%22%20ry%3D%2222%22%20fill%3D%22%23FFB300%22%20transform%3D%22rotate%2820%2056%2050%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2248%22%20rx%3D%228%22%20ry%3D%2218%22%20fill%3D%22%23FF8F00%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
    'Wheat': 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF8E1%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23FFE082%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%20%20%20%20%3Cpath%20d%3D%22M48%2078V28%22%20stroke%3D%22%23F9A825%22%20stroke-width%3D%223%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2242%22%20cy%3D%2236%22%20rx%3D%226%22%20ry%3D%2210%22%20fill%3D%22%23FFB300%22%20transform%3D%22rotate%28-30%2042%2036%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2254%22%20cy%3D%2236%22%20rx%3D%226%22%20ry%3D%2210%22%20fill%3D%22%23FFB300%22%20transform%3D%22rotate%2830%2054%2036%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2242%22%20cy%3D%2250%22%20rx%3D%226%22%20ry%3D%2210%22%20fill%3D%22%23FFA000%22%20transform%3D%22rotate%28-30%2042%2050%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2254%22%20cy%3D%2250%22%20rx%3D%226%22%20ry%3D%2210%22%20fill%3D%22%23FFA000%22%20transform%3D%22rotate%2830%2054%2050%29%22/%3E%0A%20%20%20%20%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2230%22%20rx%3D%225%22%20ry%3D%228%22%20fill%3D%22%23FF8F00%22/%3E%0A%20%20%20%20%0A%3C/svg%3E',
}
DEFAULT_CROP_IMAGE = 'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2296%22%20height%3D%2296%22%20viewBox%3D%220%200%2096%2096%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%22g%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%221%22%20y2%3D%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E8F5E9%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23C8E6C9%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%2296%22%20height%3D%2296%22%20rx%3D%2222%22%20fill%3D%22url%28%23g%29%22/%3E%0A%20%20%0A%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2256%22%20rx%3D%2222%22%20ry%3D%2214%22%20fill%3D%22%23A5D6A7%22/%3E%0A%20%20%3Cpath%20d%3D%22M48%2056V28%22%20stroke%3D%22%2366BB6A%22%20stroke-width%3D%224%22/%3E%0A%20%20%3Cellipse%20cx%3D%2248%22%20cy%3D%2228%22%20rx%3D%2210%22%20ry%3D%228%22%20fill%3D%22%2381C784%22/%3E%0A%0A%3C/svg%3E'

def crop_image(name):
    """Return an embedded SVG data-URI image for the crop (no external URL)."""
    return CROP_IMAGE.get(str(name), DEFAULT_CROP_IMAGE)
...
if page == "Market Prices":
    ...
    .gs-price-crop{font-size:1.15rem;font-weight:800;display:flex;align-items:center;gap:10px;}
    .gs-price-crop img.gs-crop-pic{width:48px;height:48px;border-radius:12px;object-fit:cover;border:1px solid rgba(46,125,50,.18);box-shadow:0 2px 8px rgba(27,94,32,.10);flex:0 0 48px;background:#E8F5E9;}
  ...
  <div class="gs-price-crop"><img class="gs-crop-pic" src="{crop_image(crop)}" alt="{html.escape(str(tr_data(crop)))}" width="48" height="48"/><span>{html.escape(str(tr_data(crop)))}</span></div>
...
BUSINESS_SELECTION_OPTIONS = {
    ...
    "Vegetable Cultivation": ["Tomato", "Onion", "Chilli", "Potato", "Cabbage", "Cauliflower", "Lady Finger", "Beans", "Cucumber", "Brinjal", "Capsicum", "Carrot"],
    ...
    "Floriculture": ["Rose", "Gerbera", "Marigold", "Chrysanthemum", "Jasmine", "Tuberose", "Crossandra", "Aster"],
...
def business_selection_options(business_name, domain_name, location):
    ...
    if domain_name == "Agriculture":
        try:
            ...
            # Prefer location-mapped crops, then activity defaults.
            local = list(AGRI_LOCATION_CROPS.get(location, []) or [])
            # Keep only local crops that also fit this activity when possible.
            local_fit = [c for c in local if c in opts] if opts else local
            combined = list(dict.fromkeys((local_fit or mapped or []) + opts + local))
            if combined:
                opts = combined
        except Exception:
            pass
    # Non-agriculture domains still get their curated species/product lists.
    if not opts:
        opts = BUSINESS_SELECTION_OPTIONS.get(business_name, ["Not specified"])
...
def _option_candidates(name, domain_name, location):
    if domain_name == "Agriculture":
        ...
        if any(items for _, items in grouped):
            return grouped
        if name == "Floriculture":
            # Prefer location-mapped crops when available; otherwise use common commercial flowers.
            flower_opts = BUSINESS_SELECTION_OPTIONS.get("Floriculture", ["Rose", "Marigold", "Jasmine", "Chrysanthemum", "Gerbera"])
            return [("Flowers", flower_opts)]
...
def dynamic_risk_analysis(name, cfg, values, score, location):
    ...
    def add(title, level, trigger, mitigation, impact=None):
        impact_map = {"High": "High potential impact", "Medium": "Moderate potential impact", "Low": "Lower potential impact"}
        # Prefer risk-specific impact text when provided so rows are not generic.
        risks.append({
            "title": title,
            "level": level,
            "trigger": trigger,
            "impact": impact if impact else impact_map.get(level, "Potential impact"),
    ...
    if market == "Poor":
        add("Market-access risk", "High",
            ...
            impact="High potential impact — weak market access can force distress sales.")
        ...
        add("Market-access risk", "Medium",
            ...
            impact="Moderate potential impact on realized price and sales reliability.")
    ...
    # title -> (display_title, mitigation, impact)
    fallback_map = {
        "Disease and mortality": ("Biological health risk", "Keep a written vaccination and hygiene schedule; isolate sick animals/birds immediately and log mortality daily.", "Can wipe out a large share of stock in one cycle."),
        "Feed-cost changes": ("Input-cost risk", "Lock at least two feed/fodder suppliers, track cost per animal or bird weekly, and keep 2–3 weeks of contingency stock.", "Sudden feed spikes can erase cycle profit."),
        "Market-price changes": ("Price risk", "Compare net price from at least two buyers before every sales cycle and avoid selling the whole lot through one channel.", "Realized price below cost leads to cash-flow stress."),
        "Pest/disease pressure": ("Biological crop risk", "Scout fields twice a week, use integrated pest management, and act at the first sign of outbreak rather than after spread.", "Yield and quality loss if not controlled early."),
        "Weather variability": ("Climate risk", "Match sowing/stocking windows to the local season, keep a short contingency plan for heat, excess rain or dry spells.", "Extreme weather can delay harvest or damage produce."),
        "Weather sensitivity": ("Climate risk", "Use season-appropriate varieties, staggered planting and shade/irrigation protection for sensitive stages.", "Sensitive stages lost to heat or rain reduce marketable yield."),
        "Water-quality failure": ("Water-quality risk", "Test water before stocking or critical irrigation, and re-check during the cycle if fish health or crop symptoms change.", "Poor water quality can cause stock loss or crop stress."),
        "Perishability": ("Perishability risk", "Harvest or process only against confirmed demand; pre-book transport and cold/covered storage for the sale window.", "Unsold stock loses value quickly."),
        "High perishability": ("Perishability risk", "Align harvest timing with buyer pickup, use graded packing and cold/covered handling for flowers and soft produce.", "Same-day quality drop if handling is delayed."),
        "Demand fluctuations": ("Demand risk", "Start with smaller pilot batches, pre-book a share of output with regular buyers, and diversify pack sizes or channels.", "Unsold surplus forces distress sales."),
        "Post-harvest handling": ("Handling risk", "Train workers on sorting, packing and temperature control; keep crates/bags clean and avoid field heat build-up.", "Poor handling cuts grade and buyer acceptance."),
        "Market-access risk": ("Market-access risk", "Maintain at least two buyer channels and compare prices before each sales cycle.", "Limited outlets reduce bargaining power."),
        "Equipment downtime": ("Equipment downtime risk", "Schedule preventive maintenance and keep critical spare parts or a local service contact ready before peak periods.", "Downtime during peak season delays sales."),
        "Biosecurity failures": ("Biosecurity risk", "Control visitor access, disinfect entry points, and separate new stock until health status is confirmed.", "One outbreak can force a full restock."),
        "Heat/stress management": ("Heat-stress risk", "Ensure ventilation, shade and adequate water during hot periods; avoid overcrowding in housing.", "Heat stress raises mortality and lowers growth."),
    }
    for base_risk in configured:
        entry = fallback_map.get(base_risk, (base_risk, f"Define a specific preventive control for {base_risk.lower()} before scaling production.", "May affect cost, quality or sales if unmanaged."))
        title, mitigation, impact = entry[0], entry[1], entry[2] if len(entry) > 2 else "Potential impact"
        if title not in triggered_titles and len(risks) < 8:
            risks.append({
                "title": title,
                "level": "Low",
                "trigger": "Business-specific baseline risk.",
                "impact": impact,
                "mitigation": mitigation,
            })
...
def business_specific_output(name, domain_name, cfg, values, score, reasons, gaps, location):
    ...
    with tabs[3]:
        ...
        if gaps:
            ...
            _md_table([tr_any("Gap"),tr_any("Action")],[[tr_any(g),tr_any(gap_specific_action(g))] for g in gaps[:6]])
...
if page == "Business Recommendation":
    ...
    auto_rainfall = automatic_location_rainfall(location)
    ...
    if domain_name == "Agriculture":
        ...
        values["rainfall"] = auto_npk.get("rainfall", LOCATION_CONTEXT.get(location, {}).get("rainfall_mm", 0))

    # Species list is location-aware; default to the first mapped option when available.
    with st.expander("🎯 " + tr_any("Species / Variety / Product Selection"), expanded=True):
        ...
        # Prefer crops mapped to the selected location when the domain is Agriculture.
        default_index = 0
        if selection_choices:
            default_index = 1  # first real option after "Not selected"
            try:
                mapped_local = list(AGRI_LOCATION_CROPS.get(location, []) or [])
                for i, opt in enumerate(selection_choices):
                    if opt in mapped_local:
                        default_index = i + 1
                        break
            except Exception:
                pass
        values["species_product"] = st.selectbox(
            ...
            index=min(default_index, len(selection_choices)),
            key=f"biz_{domain_name}_{business_name}_species_product",
            help=tr_any("Options are filtered using the selected location and climate profile where a mapping is available."),
            format_func=tr_any,
        )
        st.caption(tr_any("Species options are prioritised for the selected location and climate; change the selection if you plan a different product."))

    with st.expander("🌦️ " + tr_any("Location & Climate Parameters"), expanded=True):
        # Automatic location/climate metrics live here (not above the expanders).
        ...
        wc4.metric("🌧️ " + tr_any("Rainfall"), f"{auto_rainfall:.0f} mm")
